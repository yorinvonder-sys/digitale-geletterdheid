...
| R03 | **Schadelijke content voor minderjarigen** — AI genereert gewelddadige, seksueel expliciete, of anderszins schadelijke content voor 12-18 jarigen | Veiligheid | 2 | 5 | **10 HOOG** | AI-provider moderatie-/veiligheidsfilters op maximaal restrictief niveau (categorieën zoals intimidatie, haatzaaiende uitlatingen, seksueel expliciet en gevaarlijke content), system instructions beperken agentrol, prompt sanitizer blokkeert manipulatiepogingen | **LAAG (4)** — De veiligheidsfilters van de AI-provider zijn robuust op het strengste niveau. Restrisco zit in edge cases waar content technisch niet wordt geblokkeerd maar contextueel ongepast is voor minderjarigen. | Actief | Monitor AI-provider model-updates op wijzigingen in filtergedrag, voer periodiek red-teaming uit met leeftijdsspecifieke scenario's |
...
**Specifieke mitigatie:** Welzijnsprotocol actief, AI-provider veiligheidsinstellingen op maximaal restrictief. System instruction moet worden aangescherpt met expliciete grenzen over welke onderwerpen besproken mogen worden en op welk detailniveau.
...
**Specifieke mitigatie:** System instruction beperkt uitleg tot herkenning, niet creatie. AI-provider veiligheidsinstellingen voorkomen gedetailleerde "how-to" instructies.
...
| **TM-03: AI-provider veiligheidsinstellingen** | Moderatie-/veiligheidsfilters van de AI-provider (Mistral AI) op maximaal restrictief niveau voor categorieën zoals intimidatie, haatzaaiende uitlatingen, seksueel expliciete en gevaarlijke content. | R03, R04 | Geimplementeerd |
