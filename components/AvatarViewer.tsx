...
export const AvatarViewer: React.FC<AvatarViewerProps> = ({
    ...
    return (
        <div className={`w-full h-full relative ${variant === 'head' ? '' : 'min-h-[300px]'}`} style={variant === 'full' ? { backgroundColor: '#FCF6EA' } : undefined}>
            <Canvas
            ...
            >
                ...
                {variant === 'full' && (
                    <mesh position={[0, -0.06, 0]} rotation={[-Math.PI / 2, 0, 0]}>
                        ...
                        <meshStandardMaterial color="#E7D8BD" roughness={0.9} metalness={0} polygonOffset polygonOffsetFactor={2} polygonOffsetUnits={2} />
                    </mesh>
                )}
