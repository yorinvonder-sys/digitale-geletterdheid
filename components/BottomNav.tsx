...
export const BottomNav: React.FC<BottomNavProps> = ({ activeTab, onNavigate, gamesEnabled = false }) => {
    return (
        <nav
            className="fixed bottom-0 left-0 right-0 z-[60] bg-white/95 backdrop-blur-lg border-t border-lab-muted pb-safe sm:hidden"
            role="navigation"
                        ...
                        <button
                            ...
                            className={`
                                ...
                                ${isActive
                                    ...
                                    : 'text-lab-muted hover:text-lab-muted active:bg-lab-muted'
                                }
                            `}
                        >
