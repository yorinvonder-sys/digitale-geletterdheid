...
export const Footer: React.FC<FooterProps> = ({ onAccountDeleted, schoolId }) => {
    ...
    return (
        <>
            <footer className="w-full py-4 px-6 bg-white/80 backdrop-blur-sm border-t border-lab-muted">
                <div className="max-w-7xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-3">
                    ...
                    <div className="flex items-center gap-4">
                        ...
                        <div className="hidden sm:block w-px h-3 bg-lab-muted" />
                        <button
                            onClick={() => {
                            ...
                            className="flex items-center gap-2 text-lab-muted hover:text-indigo-600 text-xs font-medium transition-colors group"
