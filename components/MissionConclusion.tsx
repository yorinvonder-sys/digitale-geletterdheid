        ...
        <div className="min-h-full flex items-center justify-center p-6">
            <div className="max-w-2xl w-full bg-white rounded-2xl shadow-2xl overflow-hidden relative">
                ...
                <div className="p-8 md:p-12">
                    ...
                    {/* AI Insight Box */}
                    <div className={`bg-gradient-to-br from-[#FCF6EA] to-[#FCF6EA] border border-[#E7D8BD] rounded-2xl p-6 md:p-8 mb-8 relative overflow-hidden transition-all duration-700 delay-300 ${showContent ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
                    ...
                    <div className="flex flex-col md:flex-row gap-4 items-center justify-between pt-4 border-t border-[#FCF6EA]">
                        <div className="flex gap-2">
                            {onPrint && (
                                <button
                                    onClick={onPrint}
                                    className="px-6 py-3 bg-[#FCF6EA] text-[#445865] rounded-full font-bold uppercase tracking-widest hover:bg-[#FCF6EA] hover:text-[#D97848] transition-all duration-300 flex items-center gap-2 border border-[#E7D8BD] focus-visible:ring-2 focus-visible:ring-[#D97848]"
                                >
