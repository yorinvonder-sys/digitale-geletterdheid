...
export const WordWizardPreview: React.FC<WordWizardPreviewProps> = ({ onTaskComplete }) => {
    ...
    if (showIntro) {
        return (
            <div className="w-full h-full flex flex-col items-center justify-center bg-lab-muted font-sans p-6">
                <div className="bg-white rounded-2xl shadow-xl max-w-md w-full p-8 flex flex-col gap-6">
                    ...
                    <div className="bg-lab-muted rounded-xl p-5">
                    ...
                    <button
                        ...
                        className="w-full bg-[#0B453F] text-white font-bold py-3 px-6 rounded-xl hover:bg-[#1e3f73] transition-colors text-base"
                    >
                        Aan de slag
                    </button>
                </div>
            ...
            <div className="bg-[#0B453F] text-white shrink-0">
                ...
                <div className="bg-[#f3f4f6] text-lab-muted px-4 py-3 h-24 flex gap-4 shadow-sm border-b border-lab-muted overflow-x-auto">
                    ...
                    {activeTab === 'start' && (
                        <>
                            {/* STYLES SECTION */}
                            <div className="flex flex-col justify-between gap-1 pr-4 border-r border-lab-muted min-w-[140px] md:min-w-[200px]">
