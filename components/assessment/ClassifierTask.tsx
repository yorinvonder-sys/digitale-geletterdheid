                                ...
                                {!state.revealed ? (
                                    <div className="flex gap-2 px-4 pb-4">
                                        ...
                                        <button
                                            ...
                                            className="flex-1 flex items-center justify-center gap-2 py-2.5 rounded-lg border border-red-200 bg-red-50 hover:bg-red-100 text-red-600 font-bold text-sm transition-colors active:scale-95"
                                        >
