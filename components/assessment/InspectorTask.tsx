...
export const InspectorTask: React.FC<Props> = ({ task, onComplete }) => {
    ...
    return (
        <div className="flex flex-col h-full bg-lab-muted text-white p-4">
            ...
            <div className="flex-1 relative flex items-center justify-center bg-lab-muted rounded-2xl overflow-hidden border-2 border-lab-muted">
                ...
                >
                    ...
                    {task.image === 'SPECIAL:BAD_SLIDE' ? (
                        <div className="absolute inset-0 bg-white p-8 flex flex-col pointer-events-none select-none overflow-hidden relative group-hover:bg-lab-muted transition-colors">
                            {/* Terrible Background */}
                        ...
                        <div className="absolute inset-0 bg-lab-muted pointer-events-none select-none overflow-hidden flex flex-col">
                            ...
                            <div className="flex-1 flex flex-col px-4 py-3 gap-2 overflow-hidden">
                                <p className="text-[10px] text-lab-muted text-center">Twee leerlingen proberen een verhaal te maken met AI</p>
                                <div className="flex flex-col items-end mt-1">
                                    <span className="text-[9px] text-lab-muted mb-0.5">Leerling 1</span>
                                ...
                                <div className="flex flex-col items-start">
                                    <div className="bg-white border border-lab-muted px-3 py-2 rounded-2xl rounded-tl-sm max-w-[50%] shadow-sm">
                                        <p className="text-[10px] text-lab-muted italic">Eh... oké. Hier is iets: &quot;Er was eens iemand die iets deed.&quot; Ik weet niet precies wat je wilt...</p>
                                    </div>
                                </div>
                                <div className="flex items-center gap-2 my-1">
                                    <div className="flex-1 border-t border-lab-muted"></div>
                                    <span className="text-[9px] text-lab-muted">vs</span>
                                    <div className="flex-1 border-t border-lab-muted"></div>
                                </div>
                                <div className="flex flex-col items-end">
                                    <span className="text-[9px] text-lab-muted mb-0.5">Leerling 2</span>
                                    <div className="bg-blue-500 text-white px-3 py-2 rounded-2xl rounded-tr-sm max-w-[44%] ml-auto">
                                ...
                                <div className="flex flex-col items-start">
                                    <div className="bg-white border border-lab-muted px-3 py-2 rounded-2xl rounded-tl-sm max-w-[50%] shadow-sm">
                                        <p className="text-[10px] text-lab-muted italic">ROBO-7 knipperde met zijn blauwe ogen. De hoge gebouwen leken op reusachtige vingers die naar de hemel wezen. &quot;Waar ben ik?&quot; piepte hij...</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="absolute inset-0 bg-lab-muted pointer-events-none select-none overflow-hidden flex flex-col">
                            ...
                            <div className="flex-1 flex flex-col px-4 py-3 gap-2 overflow-hidden">
                                <div className="flex flex-col items-end mt-1">
                                    <span className="text-[9px] text-lab-muted mb-0.5">Leerling</span>
                                ...
                                <div className="flex flex-col items-start mt-2">
                                    <span className="text-[9px] text-lab-muted mb-0.5">SlimmeBot — Antwoord 1</span>
                                    <div className="bg-white border border-lab-muted px-3 py-2 rounded-2xl rounded-tl-sm max-w-[44%] shadow-sm">
                                        <p className="text-xs text-lab-muted">Ons zonnestelsel heeft <strong>9 planeten</strong>! De negen planeten zijn: Mercurius, Venus, Aarde, Mars, Jupiter, Saturnus, Uranus, Neptunus en Pluto. 🪐</p>
                                    </div>
                                </div>
                                <div className="flex items-center gap-2 my-1">
                                    <div className="flex-1 border-t border-lab-muted"></div>
                                    <span className="text-[9px] text-lab-muted">twee antwoorden</span>
                                    <div className="flex-1 border-t border-lab-muted"></div>
                                </div>
                                <div className="flex flex-col items-start">
                                    <span className="text-[9px] text-lab-muted mb-0.5">SlimmeBot — Antwoord 2</span>
                                    <div className="bg-white border border-lab-muted px-3 py-2 rounded-2xl rounded-tl-sm max-w-[44%] shadow-sm">
                                        <p className="text-xs text-lab-muted">Ons zonnestelsel heeft <strong>8 planeten</strong>: Mercurius, Venus, Aarde, Mars, Jupiter, Saturnus, Uranus en Neptunus. Pluto werd in 2006 herclassificeerd als dwergplaneet. 🌍</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="absolute inset-0 p-8 flex flex-col items-center justify-center text-lab-muted bg-lab-muted">
                            <h1 className="text-2xl font-bold mb-2 text-lab-muted">AFBEELDING NIET GEVONDEN</h1>
                            <p className="text-lab-muted mb-6 font-mono text-sm">{task.image}</p>
                            <p className="text-center text-lab-muted text-sm max-w-md">
                    ...
                    {clicks.map((c, i) => (
                        <div
                            key={i}
                            className="absolute w-6 h-6 -ml-3 -mt-3 border-2 border-lab-gold rounded-full animate-ping pointer-events-none"
            ...
            <div className="mt-4 bg-lab-muted p-4 rounded-xl border border-lab-muted">
