...
export const EindmetingFlow: React.FC<EindmetingFlowProps> = ({ nulmetingResult, onComplete, onBack }) => {
  ...
  if (stap === 'groei' && resultaat) {
    return (
      <div className="w-full h-full bg-lab-muted flex items-center justify-center p-6">
        <div className="max-w-md w-full bg-white rounded-2xl p-6 md:p-8 border border-lab-muted shadow-sm text-center">
          ...
          <h2 className="text-2xl font-black text-lab-muted mb-2">Groei wordt berekend...</h2>
          ...
          <button
            ...
            className="w-full py-4 bg-lab-sage hover:bg-lab-sage rounded-xl font-black text-lg text-white shadow-lg shadow-emerald-200 hover:scale-[1.02] transition-all active:scale-[0.98]"
          >
