  ...
  return (
    ...
    >
      ...
      <div className="flex-1 flex flex-col md:flex-row gap-4 min-h-0">
        {/* Gekozen volgorde */}
        <div className="md:w-1/2 bg-white rounded-xl border border-lab-muted shadow-sm p-4 flex flex-col">
          <h3 className="text-xs font-bold uppercase tracking-wider text-lab-muted mb-3">Jouw code (klik om toe te voegen)</h3>
          <div className="flex-1 space-y-2">
            {gekozen.length === 0 && (
              <div className="h-full flex items-center justify-center text-lab-muted text-sm border-2 border-dashed border-lab-muted rounded-xl p-4">
            ...
            {gekozen.map((blok, index) => (
              ...
              >
                <div className="w-6 h-6 rounded-full bg-lab-teal text-white flex items-center justify-center text-xs font-bold shrink-0">
                  {index + 1}
                </div>
                <button
        ...
        {/* Beschikbare blokken */}
        <div className="md:w-1/2 bg-lab-muted rounded-xl border border-lab-muted p-4 flex flex-col">
          ...
          <div className="flex-1 space-y-2">
            {beschikbareBlokken.map(blok => (
              <button
                ...
                disabled={!!resultaat}
                className="w-full text-left px-4 py-3 bg-white border border-lab-muted rounded-lg font-mono text-sm text-lab-muted hover:border-lab-teal hover:bg-lab-teal transition-colors active:scale-[0.98]"
              >
                + {blok.tekst}
              </button>
            ))}
        ...
        {resultaat === 'fail' ? (
          <>
            <button
              ...
              className="px-4 py-3 bg-white border border-lab-muted text-lab-muted rounded-xl font-bold hover:bg-lab-muted transition-colors flex items-center gap-2"
            >
              <RotateCcw size={18} /> Opnieuw
            </button>
            <button
              onClick={gaVerderMetScore}
              className="flex-1 py-3 rounded-xl font-bold text-lg transition-all bg-lab-teal hover:bg-lab-teal text-white shadow-lg shadow-violet-200 active:scale-[0.98] flex items-center justify-center gap-2"
            >
          ...
          <>
            <button
              ...
              className="px-4 py-3 bg-white border border-lab-muted text-lab-muted rounded-xl font-bold hover:bg-lab-muted disabled:opacity-40 transition-colors flex items-center gap-2"
            >
            ...
            <button
              ...
              className="flex-1 py-3 rounded-xl font-bold text-lg transition-all disabled:opacity-40 disabled:cursor-not-allowed bg-lab-teal hover:bg-lab-teal text-white shadow-lg shadow-violet-200 active:scale-[0.98] flex items-center justify-center gap-2"
            >
