                ...
                >
                                                ...
                                                {sortedAssigned.map((mc, index) => {
                                                    ...
                                                    return (
                                                        <li key={mc.missionId} className="flex items-center gap-2 px-3 py-2.5 bg-white">
                                                            ...
                                                            {/* Short badge */}
                                                            <span className="w-6 h-6 flex-shrink-0 bg-indigo-100 rounded-md flex items-center justify-center text-[9px] font-black text-indigo-600">
                                                                {info?.short ?? '?'}
                                                            </span>
                    ...
                    <div className="flex-shrink-0 flex items-center justify-end gap-3 px-6 py-4 border-t border-lab-muted bg-lab-muted">
                        ...
                        <button
                            onClick={handleSave}
                            disabled={!label.trim()}
                            className="px-6 py-2.5 text-sm font-bold bg-indigo-600 text-white rounded-xl hover:bg-indigo-700 disabled:opacity-40 disabled:cursor-not-allowed transition-colors shadow-sm"
                        >
                            Opslaan
                        </button>
                    </div>
