...
export function DeveloperDocsViewer() {
  return (
    <div className="space-y-6 animate-in fade-in duration-300">
      <div className="bg-white rounded-3xl border border-lab-muted shadow-sm p-8 md:p-10">
        <div className="w-14 h-14 rounded-2xl bg-lab-gold text-lab-gold flex items-center justify-center mb-6">
          <Lock size={28} />
        </div>
        <h2 className="text-2xl font-black text-lab-muted mb-3">Interne documentatie is uit de publieke build gehaald</h2>
      ...
      <div className="bg-lab-muted rounded-3xl p-8 border border-lab-muted flex items-start gap-4">
