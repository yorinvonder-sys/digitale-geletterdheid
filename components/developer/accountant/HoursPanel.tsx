...
export function HoursPanel({ userId, year }: HoursPanelProps) {
    ...
    return (
        <div className="space-y-8">
            ...
            <div className="bg-lab-muted text-white rounded-[2rem] p-8">
                                    ...
                                    >
                                        ...
                                        <td className="px-6 py-4 text-right">
                                            <button
                                                ...
                                                className={`p-1.5 rounded-lg text-lab-muted hover:text-red-500 hover:bg-red-50 transition-all ${hoveredRow === entry.id ? 'opacity-100' : 'opacity-0 group-hover:opacity-100'}`}
                                                title="Verwijderen"
                                            >
                                                <Trash2 size={14} />
                                            </button>
