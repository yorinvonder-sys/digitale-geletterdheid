                    ...
                    <div className="bg-white rounded-3xl shadow-2xl w-full max-w-md p-5 sm:p-8 max-h-[90vh] overflow-y-auto">
                        ...
                        <div className="mb-5">
                            ...
                            <button
                                ...
                                disabled={scanning}
                                className="w-full flex items-center justify-center gap-2 px-4 py-3 border-2 border-dashed border-lab-muted rounded-xl text-sm font-bold text-lab-muted hover:border-indigo-300 hover:text-indigo-600 hover:bg-indigo-50/50 transition-all disabled:opacity-60 disabled:cursor-wait"
                            >
                                {scanning ? (
                                    <>
