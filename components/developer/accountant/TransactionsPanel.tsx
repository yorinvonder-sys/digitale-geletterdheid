        ...
        <div className="space-y-6">
            ...
            {showImport && (
                <div className="bg-lab-muted border border-lab-muted rounded-2xl p-6 space-y-4">
                    ...
                    <div
                        className="border-2 border-dashed border-lab-muted rounded-xl p-8 text-center cursor-pointer hover:border-indigo-400 hover:bg-indigo-50 transition-colors"
                                        ...
                                        >
                                            ...
                                            <td className="px-4 py-4">
                                                <button
                                                    ...
                                                    className="opacity-0 group-hover:opacity-100 p-1.5 text-lab-muted hover:text-red-500 hover:bg-red-50 rounded-lg transition-all"
                                                >
                                                    <Trash2 size={14} />
                                                </button>
                                            </td>
