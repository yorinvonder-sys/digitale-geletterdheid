...
const ROLLEN_KLEUREN: Record<string, string> = {
    ...
    docent: 'bg-green-100 text-green-800',
        ...
        <div className="min-h-screen bg-lab-muted flex flex-col">
                                                ...
                                                {resultaat === null || resultaat === undefined ? (
                                                    ...
                                                    <>
                                                        <div className={`flex items-center gap-1 px-3 py-1.5 rounded-lg text-xs font-bold ${
                                                            resultaat === 'correct' ? 'bg-green-100 text-green-700' : 'bg-red-100 text-red-700'
                                                        }`}>
                                                            {resultaat === 'correct'
            ...
            {coachMessage && (
                <div className="fixed bottom-4 left-4 right-4 max-w-lg mx-auto z-30 animate-in slide-in-from-bottom-4">
                    <div className="bg-indigo-50 border border-indigo-200 rounded-xl p-3 shadow-lg flex items-start gap-3">
                        <div className="w-8 h-8 bg-indigo-100 rounded-full flex items-center justify-center shrink-0">
                            <MessageCircle size={16} className="text-indigo-600" />
                        </div>
                        <div className="flex-1 min-w-0">
                            <p className="text-xs font-semibold text-indigo-700 mb-0.5">Security Coach</p>
                            <p className="text-sm text-indigo-800">{coachMessage}</p>
                        </div>
                        <button
