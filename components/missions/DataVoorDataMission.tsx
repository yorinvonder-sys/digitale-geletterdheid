        ...
        return (
            <div className="min-h-screen bg-[#FCF6EA] text-[#08283B] overflow-y-auto p-4 pb-safe">
                ...
                <div className="max-w-lg mx-auto text-center space-y-6">
                    ...
                    <p className="text-[#445865] text-xs" style={{ fontFamily: "'Outfit', system-ui, sans-serif" }}>5 rondes -- vergelijk je keuzes met anderen</p>
                ...
                <div className="max-w-lg mx-auto">
                    ...
                    {showExplanation && (
                        <div className="mt-6 space-y-4">
                            ...
                            <div className="bg-white rounded-2xl border border-[#E7D8BD] p-3 flex items-center justify-between">
                                <span className="text-xs text-[#445865]" style={{ fontFamily: "'Outfit', system-ui, sans-serif" }}>Anderen die DEAL kozen:</span>
                                <div className="flex items-center gap-2">
                                    <div className="w-24 h-2 bg-[#FCF6EA] rounded-full overflow-hidden"><div className="h-full bg-gradient-to-r from-[#D97848] to-[#D97848] rounded-full" style={{ width: `${round.avgStat}%` }} /></div>
                                    <span className="text-xs font-black text-[#D97848]">{round.avgStat}%</span>
                                </div>
                            </div>
        ...
        <div className="min-h-screen bg-[#FCF6EA] text-[#08283B] overflow-y-auto">
            ...
            <div className="max-w-sm w-full text-center space-y-6">
                ...
                <div className="bg-white rounded-2xl p-4 text-left space-y-3 border border-[#E7D8BD]">
                    <p className="text-xs font-bold text-[#445865]" style={{ fontFamily: "'Outfit', system-ui, sans-serif" }}>Jouw keuzes vs. het gemiddelde:</p>
                    {ROUNDS.map((r, i) => (
                        <div key={i} className="flex items-center justify-between">
                            ...
                            <div className="flex items-center gap-2">
                                ...
                                <span className="text-[10px] text-[#445865]">({r.avgStat}% deal)</span>
                            </div>
                        </div>
                    ))}
                </div>
