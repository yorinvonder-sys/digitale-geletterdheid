        ...
        <div className="flex-1 min-w-0">
          <div className="flex flex-wrap gap-1">
            {item.features.map((f, i) => (
              <span key={i} className="text-[10px] px-1.5 py-0.5 rounded-full font-medium" style={{ backgroundColor: '#FCF6EA', color: '#445865', border: '1px solid #E7D8BD' }}>
                {f}
              </span>
            ))}
          </div>
  ...
  return (
    <div className="space-y-4">
      <div className="rounded-2xl p-4" style={{ backgroundColor: '#FFFFFF', border: '1px solid #E7D8BD' }}>
        ...
        <div className="grid grid-cols-3 gap-1 max-w-xs mx-auto">
          ...
          <div className="rounded-lg p-3 text-center font-black text-lg" style={{
            backgroundColor: tp > 0 ? 'rgba(16, 185, 129, 0.08)' : '#FCF6EA',
          ...
          <div className="rounded-lg p-3 text-center font-black text-lg" style={{
            backgroundColor: fn > 0 ? 'rgba(239, 68, 68, 0.08)' : '#FCF6EA',
          ...
          <div className="rounded-lg p-3 text-center font-black text-lg" style={{
            backgroundColor: fp > 0 ? 'rgba(239, 68, 68, 0.08)' : '#FCF6EA',
          ...
          <div className="rounded-lg p-3 text-center font-black text-lg" style={{
            backgroundColor: tn > 0 ? 'rgba(16, 185, 129, 0.08)' : '#FCF6EA',
      ...
      <div className="rounded-2xl p-4 text-center" style={{ backgroundColor: '#FFFFFF', border: '1px solid #E7D8BD' }}>
        ...
        <div className="w-full rounded-full h-3 mt-3 overflow-hidden" style={{ backgroundColor: '#FCF6EA' }}>
          <div
            className="h-full rounded-full transition-all duration-700"
            style={{
              width: `${accuracy}%`,
              background: accuracy >= 80 ? 'linear-gradient(to right, #5F947D, #5F947D)' : accuracy >= 50 ? 'linear-gradient(to right, #D97848, #D97848)' : 'linear-gradient(to right, #D97848, #D97848)'
            }}
          />
        </div>
      </div>
      ...
      <div className="min-h-screen text-white overflow-y-auto p-4 pb-safe" style={{ backgroundColor: '#FCF6EA' }}>
        ...
        <div className="max-w-lg mx-auto text-center space-y-6">
          <div className="relative inline-block">
            ...
            <div className="relative w-24 h-24 rounded-3xl flex items-center justify-center shadow-2xl" style={{ background: 'linear-gradient(to bottom right, #5F947D, #1a7a6f)' }}>
          ...
          {/* Example */}
          <div className="rounded-2xl p-4" style={{ backgroundColor: '#FFFFFF', border: '1px solid #FCF6EA' }}>
    ...
    return (
      <div className="min-h-screen overflow-y-auto pb-safe" style={{ backgroundColor: '#FCF6EA' }}>
        ...
        <div className="sticky top-0 z-20 backdrop-blur-md" style={{ backgroundColor: 'rgba(255, 255, 255, 0.9)', borderBottom: '1px solid #E7D8BD' }}>
          ...
          <div className="h-1" style={{ backgroundColor: '#FCF6EA' }}>
            <div
              className="h-full transition-all duration-300"
              style={{ width: `${(labeledCount / items.length) * 100}%`, background: 'linear-gradient(to right, #D97848, #D97848)' }}
            />
          </div>
        </div>
            ...
            <div className="rounded-2xl p-5 space-y-4" style={{ backgroundColor: '#FFFFFF', border: '2px solid rgba(217, 119, 87, 0.3)' }}>
              <div className="text-center">
                ...
                <div className="flex flex-wrap gap-2 justify-center">
                  {currentItem.features.map((f, i) => (
                    <span key={i} className="text-sm px-3 py-1.5 rounded-full font-bold" style={{ backgroundColor: '#FCF6EA', color: '#08283B', border: '1px solid #E7D8BD' }}>
                      {f}
                    </span>
                  ))}
                </div>
              ...
              <div className="flex gap-3">
                <button
                  ...
                  style={{
                    backgroundColor: currentItem.label === 'appel' ? '#D97848' : 'rgba(239, 68, 68, 0.06)',
                    color: currentItem.label === 'appel' ? '#FFFFFF' : '#D97848',
                    border: `2px solid ${currentItem.label === 'appel' ? '#D97848' : 'rgba(239, 68, 68, 0.2)'}`,
                ...
                <button
                  ...
                  className="flex-1 py-4 rounded-full font-black text-lg flex items-center justify-center gap-2 transition-all duration-300 active:scale-95"
                  style={{
                    backgroundColor: currentItem.label === 'banaan' ? '#D7C95F' : 'rgba(245, 158, 11, 0.06)',
                    color: currentItem.label === 'banaan' ? '#FFFFFF' : '#D7C95F',
                    border: `2px solid ${currentItem.label === 'banaan' ? '#D7C95F' : 'rgba(245, 158, 11, 0.2)'}`,
    ...
    return (
      <div className="min-h-screen overflow-y-auto pb-safe" style={{ backgroundColor: '#FCF6EA' }}>
        ...
        <div className="sticky top-0 z-20 backdrop-blur-md" style={{ backgroundColor: 'rgba(255, 255, 255, 0.9)', borderBottom: '1px solid #E7D8BD' }}>
          <div className="max-w-2xl mx-auto px-4 py-3 flex items-center justify-between">
            ...
            <div className="flex items-center gap-3">
              <span className="text-xs font-bold px-2 py-1 rounded-full" style={{ backgroundColor: 'rgba(217, 119, 87, 0.1)', color: '#D97848', border: '1px solid rgba(217, 119, 87, 0.2)' }}>Train: {trainItems.length}</span>
              <span className="text-xs font-bold px-2 py-1 rounded-full" style={{ backgroundColor: 'rgba(139, 111, 158, 0.1)', color: '#0B453F', border: '1px solid rgba(139, 111, 158, 0.2)' }}>Test: {testItems.length}</span>
            </div>
            {canTrain && (
              <button
        ...
        <div className="max-w-2xl mx-auto px-4 py-6 space-y-4">
          ...
          {/* Split explanation */}
          <div className="rounded-2xl p-3" style={{ backgroundColor: '#FFFFFF', border: '1px solid #FCF6EA' }}>
          ...
          <div className="flex items-center justify-center gap-4 text-xs">
            <div className="flex items-center gap-1.5">
              <div className="w-3 h-3 rounded" style={{ backgroundColor: '#FCF6EA' }} />
    ...
    <div className="min-h-screen overflow-y-auto" style={{ backgroundColor: '#FCF6EA' }}>
      <div className="min-h-full flex items-center justify-center p-4 pb-safe">
        <div className="max-w-md w-full space-y-6">
          ...
          <div className="rounded-2xl p-4 space-y-2" style={{ backgroundColor: '#FFFFFF', border: '1px solid #FCF6EA' }}>
          ...
          <button
            ...
            style={{
              ...
              color: saved.reflectie.trim().length < 10 ? '#B5B5AF' : '#FFFFFF',
