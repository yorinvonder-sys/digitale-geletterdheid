...
export const PitchPoliceMission: React.FC<PitchPoliceProps> = ({ onComplete, onBack }) => {
    ...
    if (showIntro) {
        return (
            <div className="min-h-screen bg-[#FCF6EA] flex flex-col items-center justify-center p-6 text-[#08283B] relative overflow-hidden" style={{ fontFamily: "'Outfit', system-ui, sans-serif" }}>
                ...
                <div className="absolute inset-0 opacity-10 pointer-events-none">
                    ...
                    <div className="absolute top-1/2 left-1/3 w-24 h-24 bg-[#5F947D] rounded-full blur-2xl animate-pulse" style={{ animationDelay: '0.5s' }} />
                </div>

                <div className="max-w-2xl w-full text-center relative z-10">
                    {/* Icon */}
                    <div className="relative inline-block mb-8">
                        <div className="w-28 h-28 bg-gradient-to-br from-[#D97848] to-[#D97848] rounded-[2rem] flex items-center justify-center shadow-2xl shadow-[#D97848]/30 transform rotate-3">
                            <Monitor size={56} className="text-white" />
                        </div>
                        <div className="absolute -bottom-2 -right-2 w-12 h-12 bg-[#5F947D] rounded-xl flex items-center justify-center text-2xl shadow-lg transform -rotate-6 text-white font-bold">
                            !
                        </div>
                    </div>
                    ...
                    <h1 className="text-4xl md:text-5xl font-black mb-4 tracking-tight" style={{ fontFamily: "'Newsreader', Georgia, serif" }}>
                        Welkom bij de <span className="text-[#D97848]">Pitch Politie!</span>
                    </h1>

                    <p className="text-xl text-[#445865] mb-8 leading-relaxed max-w-xl mx-auto">
                        Jij bent vandaag de presentatie-expert. Help medeleerlingen hun saaie of rommelige slides te verbeteren!
                    </p>

                    {/* Instructions Card */}
                    <div className="bg-white border border-[#E7D8BD] rounded-2xl p-8 mb-8 text-left shadow-sm">
                        <h3 className="text-sm font-black text-[#D97848] uppercase tracking-widest mb-4 flex items-center gap-2">
                            <Zap size={16} /> Hoe werkt het?
                        </h3>
                        <ul className="space-y-4 text-lg">
                            <li className="flex items-start gap-4">
                                <span className="bg-[#D97848]/10 text-[#D97848] rounded-full w-8 h-8 flex items-center justify-center shrink-0 font-bold text-sm">1</span>
                                <span className="text-[#445865]">Je ziet <strong className="text-[#08283B]">slides met fouten</strong> -- te veel tekst, slechte kleuren, of chaos</span>
                            </li>
                            <li className="flex items-start gap-4">
                                <span className="bg-[#D97848]/10 text-[#D97848] rounded-full w-8 h-8 flex items-center justify-center shrink-0 font-bold text-sm">2</span>
                                <span className="text-[#445865]">Lees het <strong className="text-[#08283B]">Politie Rapport</strong> om te zien wat er mis is</span>
                            </li>
                            <li className="flex items-start gap-4">
                                <span className="bg-[#D97848]/10 text-[#D97848] rounded-full w-8 h-8 flex items-center justify-center shrink-0 font-bold text-sm">3</span>
                                <span className="text-[#445865]">Kies de <strong className="text-[#08283B]">beste oplossing</strong> om de slide te fixen</span>
                            </li>
                            <li className="flex items-start gap-4">
                                <span className="bg-[#5F947D]/10 text-[#5F947D] rounded-full w-8 h-8 flex items-center justify-center shrink-0 font-bold text-sm">✓</span>
                                <span className="text-[#445865]">Zie de slide <strong className="text-[#08283B]">live verbeteren</strong> voor je ogen!</span>
                            </li>
                        </ul>
                    </div>
                    ...
                    <div className="flex flex-wrap justify-center gap-4 mb-10">
                        <div className="bg-white border border-[#E7D8BD] rounded-full px-4 py-2 flex items-center gap-2 text-sm">
                            <Type size={16} className="text-[#5F947D]" />
                            <span className="text-[#445865]">Minder tekst = Beter</span>
                        </div>
                        <div className="bg-white border border-[#E7D8BD] rounded-full px-4 py-2 flex items-center gap-2 text-sm">
                            <Palette size={16} className="text-[#0B453F]" />
                            <span className="text-[#445865]">Goed contrast is key</span>
                        </div>
                        <div className="bg-white border border-[#E7D8BD] rounded-full px-4 py-2 flex items-center gap-2 text-sm">
                            <Layout size={16} className="text-[#5F947D]" />
                    ...
                    <button
                        ...
                        className="px-12 py-5 bg-[#D97848] hover:bg-[#D97848] text-white rounded-full font-black text-xl shadow-2xl shadow-[#D97848]/30 hover:scale-105 transition-all duration-300 flex items-center gap-3 mx-auto group focus-visible:ring-2 focus-visible:ring-[#D97848]"
                    >
                    ...
                    <button
                        onClick={onBack}
                        className="mt-6 text-[#445865] hover:text-[#08283B] text-sm font-medium flex items-center gap-2 mx-auto transition-all duration-300 focus-visible:ring-2 focus-visible:ring-[#D97848] rounded-full px-3 py-1"
                    >
                        <ArrowLeft size={16} />
                        Terug naar missies
                    </button>
    ...
    return (
        <div className="min-h-screen bg-[#08283B] flex flex-col text-white" style={{ fontFamily: "'Outfit', system-ui, sans-serif" }}>
            ...
            <div className="flex-1 flex overflow-hidden">
                {/* Thumbnails Sidebar */}
                <aside className="w-48 bg-[#2d2d2a] border-r border-[#445865] p-4 flex flex-col gap-4 overflow-y-auto hidden md:flex">
                ...
                {/* Main Slide Editor */}
                <main className="flex-1 bg-[#08283B] p-8 flex items-center justify-center relative flex-col gap-6">
                    {/* The Slide Container */}
                    ...
                    {isFixed && (
                        <button
                            ...
                            className="bg-[#5F947D] text-white px-8 py-3 rounded-full font-bold text-lg shadow-lg hover:bg-lab-sage hover:scale-105 transition-all duration-300 flex items-center gap-2 animate-in slide-in-from-bottom-5 fade-in focus-visible:ring-2 focus-visible:ring-[#5F947D]"
                        >
                ...
                <aside className={`w-80 bg-[#2d2d2a] border-l border-[#445865] flex flex-col transition-all duration-500 ${isFixed ? 'opacity-30 pointer-events-none grayscale' : 'opacity-100'}`}>
                    <div className="p-6">
                        <div className="mb-6">
