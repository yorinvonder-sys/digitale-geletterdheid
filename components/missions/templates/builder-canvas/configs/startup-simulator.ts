...
export const startupSimulatorConfig: BuilderCanvasConfig = {
    ...
    maxScore: 100,
    badges: [
        { minScore: 90, emoji: '🏆', title: 'Startup Founder', color: '#F59E0B' },
        { minScore: 70, emoji: '🚀', title: 'Tech Entrepreneur', color: '#10B981' },
        { minScore: 50, emoji: '💡', title: 'Ideeënmachine', color: '#D97757' },
        { minScore: 25, emoji: '🌱', title: 'Beginnende Ondernemer', color: '#8B5CF6' },
