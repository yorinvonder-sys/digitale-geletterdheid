...
export const InteractiveTable: React.FC<InteractiveTableProps> = ({ columns, rows }) => {
    ...
    return (
        <div className="rounded-xl border border-[#E7D8BD] overflow-hidden">
            {/* Filter row */}
            <div className="bg-[#F5F4EC] border-b border-[#E7D8BD] px-3 py-2 flex gap-2 flex-wrap">
                {columns.map(col => (
                    <input
                        key={col.key}
                        type="text"
            ...
            <div className="overflow-x-auto">
                <table className="w-full min-w-[480px]">
                    <thead>
                        <tr className="bg-[#F5F4EC] border-b border-[#E7D8BD]">
                            {columns.map(col => (
                                <th
                                    key={col.key}
            ...
            {/* Row count */}
            <div className="bg-[#F5F4EC] border-t border-[#E7D8BD] px-4 py-1.5">
                <span
