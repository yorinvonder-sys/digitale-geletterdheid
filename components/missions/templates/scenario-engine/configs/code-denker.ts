            ...
            items: [
                {
                    ...
                    description:
                        'Haal de brodzak uit de kast, trek de clip eraf en haal twee sneetjes brood tevoorschijn.',
                    correctPosition: 0,
                    explanation:
        ...
        // ── RONDE 4: select-correct ───────────────────────────────────────────────
        {
            ...
            items: [
                ...
                },
                {
                    ...
                    description:
                        'Dagtemperaturen door de week: 15, 22, 18, 25, 20, 28. Is hier een patroon?',
                    correct: true,
                    explanation:
                        'Er zijn twee patronen door elkaar: oneven posities (15, 18, 20) zijn lager en stijgen licht; even posities (22, 25, 28) zijn hoger en stijgen ook licht. Dit zijn nacht- en dagtemperaturen. Patroonherkenning in data vereist soms meerdere lagen.',
                },
                {
                    id: 6,
                    icon: '🔤',
                    title: 'A, C, F, J, O, ...',
                    description:
                        'Een reeks letters: A, C, F, J, O. Wat is de volgende letter?',
                    correct: true,
                    explanation:
                        'Patroon in de tussenruimtes: A→C = +2, C→F = +3, F→J = +4, J→O = +5. De volgende stap is +6, dus O→U. Het patroon is dat de sprong steeds één groter wordt. Computers kunnen dit soort geneste patronen leren herkennen via machine learning.',
                },
                {
                    id: 7,
                    icon: '🎵',
                    title: 'Do, Re, Mi, Fa, ...',
                    description:
                        'De muzieknoten: Do, Re, Mi, Fa. Wat komt daarna?',
                    correct: true,
                    explanation:
                        'Sol, La, Si — de toonladder is een cyclisch patroon. Muziek is volledig gebaseerd op wiskundige patronen in frequenties. Spotify-algoritmes herkennen muzikale patronen om aanbevelingen te doen.',
                },
                {
                    id: 8,
                    icon: '🌈',
