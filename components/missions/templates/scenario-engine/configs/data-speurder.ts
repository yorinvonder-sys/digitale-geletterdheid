        ...
        // ── RONDE 1: select-correct ───────────────────────────────────────────────
        {
            ...
            items: [
                ...
                },
                {
                    ...
                    correct: true,
                    explanation:
                        'Dit is een berekende meetwaarde (gemiddelde) op basis van ruwe data (individuele cijfers). Het gemiddelde zelf is informatief, maar het is nog steeds een feitelijk getal zonder interpretatie.',
                },
                {
                    id: 6,
                    icon: '🎮',
        ...
        // ── RONDE 4: select-correct ───────────────────────────────────────────────
        {
            ...
            items: [
                ...
                },
                {
                    ...
                    description:
                        'Vergelijking van het gemeten gemiddelde (3,8 uur) met de aanbevolen waarde (2 uur).',
                    correct: true,
                    explanation:
                        'Dit is een terechte conclusie. Je vergelijkt jouw meetwaarde (3,8 uur) met een externe referentie (2 uur aanbeveling). Dat is een valide en nuttige conclusie op basis van de data.',
                },
                {
                    id: 6,
                    icon: '🔮',
