...
const config: ScenarioEngineConfig = {
    ...
    introFeatures: [
        'Herken welke app-features bedoeld zijn om je aandacht te gijzelen',
    ...
    takeaways: [
        ...
        'Rode badges, streaks en "iemand die je misschien kent…" zijn niet toevallig: ze activeren hetzelfde beloningssysteem als gokken.',
        ...
        // ── RONDE 1: select-correct ───────────────────────────────────────────────
        {
            ...
            items: [
                ...
                },
                {
                    ...
                    correct: true,
                    explanation:
                        'Autoplay verwijdert het bewuste beslissingsmoment om door te kijken. Je blijft kijken uit inertie, niet uit keuze. Netflix schatte zelf dat autoplay het kijkgedrag met 50% verhoogt.',
                },
                {
                    id: 5,
                    icon: '🔄',
                    ...
                    correct: true,
                    explanation:
                        'De pull-down beweging en de korte vertraging zijn bewust ontworpen om het gevoel van een gokautomaat na te bootsen. Je weet nooit wat er uitkomt — en die onzekerheid houdt je bezig.',
                },
                {
                    id: 6,
                    icon: '💾',
                ...
                },
                {
                    ...
                    correct: true,
                    explanation:
                        'Infinite scroll verwijdert het natuurlijke stoppunt. Aza Raskin, die de techniek uitvond, bood er later zijn excuses voor aan. Hij schatte dat het 200.000 extra uren scrolltijd per dag produceert.',
                },
                {
                    id: 8,
                    icon: '❤️',
