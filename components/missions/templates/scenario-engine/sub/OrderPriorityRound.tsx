                ...
                <div className="bg-[#FCF6EA] rounded-xl p-3 mb-4 border border-[#E7D8BD]">
                    <div className="flex items-center justify-between mb-2">
                        ...
                        {!submitted && (
                            <button
                                onClick={onReset}
                                className="text-[#445865] hover:text-[#D97848] transition-colors"
                                ...
                                <div
                                    ...
                                    className={`flex items-center gap-2 p-2 rounded-lg text-xs transition-all ${
                                        submitted
                                            ...
                                            : isClose ? 'bg-lab-gold text-lab-gold'
                ...
                <div className="space-y-2 mb-4">
                    ...
                    {remaining.map((item) => (
                        <button
                            ...
                            className="w-full p-3 rounded-xl border-2 border-[#E7D8BD] bg-white hover:border-[#D97848] hover:bg-[#D97848]/5 text-left transition-all duration-200 flex items-center gap-3"
                        >
                            ...
                            <div className="flex-1 min-w-0">
                                ...
                                <p
                                    className="text-xs text-[#445865] truncate"
                                    style={{ fontFamily: "'Outfit', system-ui, sans-serif" }}
                                >
                                    {item.description}
                                </p>
