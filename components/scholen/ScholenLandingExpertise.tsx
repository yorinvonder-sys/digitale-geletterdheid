...
export const ScholenLandingExpertise: React.FC = () => {
    return (
        <div className="max-w-5xl mx-auto">
            ...
            <div className="max-w-lg mx-auto">
                <div className="relative bg-white rounded-2xl border p-8 hover:shadow-lg transition-[box-shadow] group overflow-hidden" style={{ borderColor: '#E7D8BD' }}>
                    ...
                    <div className="relative">
                        ...
                        <h4 className="font-medium text-lg mb-1" style={{ fontFamily: "'Newsreader', Georgia, serif", color: '#08283B' }}>Yorin Vonder</h4>
            ...
            {/* Pilot school banner */}
            <div className="mt-10 rounded-2xl p-8 flex flex-col md:flex-row items-center justify-between gap-6 shadow-xl overflow-hidden relative" style={{ background: 'linear-gradient(to right, #D97848, #D97848)', boxShadow: '0 20px 25px -5px #D9784825' }}>
