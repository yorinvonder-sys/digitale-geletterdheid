...
const StepHeader: React.FC<{ step: number; title: string; estimate: string }> = ({ step, title, estimate }) => (
    <div className="flex items-center gap-4 mb-6">
        ...
        <div>
            <h2 className="text-xl font-bold text-lab-muted">{title}</h2>
...
const CheckItem: React.FC<{ children: React.ReactNode }> = ({ children }) => (
    <li className="flex items-start gap-3">
        <div className="mt-0.5 text-lab-sage shrink-0"><IconCheck /></div>
...
const CodeBlock: React.FC<{ children: string }> = ({ children }) => {
    ...
    return (
        <div className="relative bg-lab-muted rounded-xl p-4 my-4 group">
            <button
                onClick={handleCopy}
    ...
    return (
        <div className="min-h-screen bg-lab-muted py-12 px-6">
            <div className="max-w-4xl mx-auto">
                <a href="/ict/technisch" className="inline-flex items-center gap-2 text-lab-muted hover:text-indigo-600 font-medium mb-12 transition-colors min-h-[44px] py-2">
                    <IconArrowLeft />
                    Terug naar technische vereisten
                </a>

                <h1 className="text-4xl font-bold text-lab-muted mb-4">ICT Implementatiegids</h1>
                ...
                <div className="flex flex-wrap gap-3 mb-12">
                    ...
                    <span className="px-3 py-1 bg-lab-sage text-lab-sage text-xs font-medium rounded-full">Geen installatie nodig</span>
                    <span className="px-3 py-1 bg-lab-gold text-lab-gold text-xs font-medium rounded-full">~30 min doorlooptijd</span>
                </div>

                {/* Stap 1 */}
                <section className="bg-white rounded-2xl p-6 md:p-8 border border-lab-muted shadow-sm mb-8">
...
*.googleapis.com`}</CodeBlock>
                    <div className="bg-lab-muted rounded-xl p-4 mt-4">
                ...
                <section className="bg-white rounded-2xl p-6 md:p-8 border border-lab-muted shadow-sm mb-8">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div className="border border-lab-muted rounded-xl p-5">
                            <div className="flex items-center gap-3 mb-4">
                                ...
                                <h3 className="font-bold text-lab-muted text-sm">Microsoft 365</h3>
                            </div>
                        ...
                        <div className="border border-lab-muted rounded-xl p-5">
                            <div className="flex items-center gap-3 mb-4">
                                <div className="w-8 h-8 bg-white border border-lab-muted rounded-lg flex items-center justify-center">
                                ...
                                <h3 className="font-bold text-lab-muted text-sm">Google Workspace</h3>
                            </div>
                            <ol className="space-y-2 text-sm text-lab-muted">
                ...
                <section className="bg-white rounded-2xl p-6 md:p-8 border border-lab-muted shadow-sm mb-8">
                    ...
                    <div className="space-y-3">
                        <div className="bg-lab-muted rounded-xl p-4">
                            <p className="text-sm font-bold text-lab-muted mb-2">A. Inloggen testen</p>
                            <ul className="space-y-2">
                        ...
                        <div className="bg-lab-muted rounded-xl p-4">
                            <p className="text-sm font-bold text-lab-muted mb-2">B. AI-chat testen</p>
                            <ul className="space-y-2">
                        ...
                        <div className="bg-lab-muted rounded-xl p-4">
                            <p className="text-sm font-bold text-lab-muted mb-2">C. Docentenfuncties testen</p>
                            <ul className="space-y-2">
                ...
                <section className="bg-white rounded-2xl p-6 md:p-8 border border-lab-muted shadow-sm mb-8">
                    ...
                    <div className="border border-lab-muted rounded-xl overflow-hidden">
                        <table className="w-full text-left border-collapse">
                            <thead>
                                <tr className="text-xs font-bold text-lab-muted uppercase tracking-wider bg-lab-muted">
                                    <th className="px-6 py-3 border-b border-lab-muted">Fase</th>
                                    <th className="px-6 py-3 border-b border-lab-muted">Wie</th>
                                    <th className="px-6 py-3 border-b border-lab-muted">Wanneer</th>
                                </tr>
                            </thead>
                            <tbody className="text-sm">
                                <tr className="hover:bg-lab-muted transition-colors">
                                    <td className="px-6 py-4 border-b border-lab-muted font-medium text-lab-muted">Pilotgroep</td>
                                    <td className="px-6 py-4 border-b border-lab-muted text-lab-muted">1-2 klassen met enthousiaste docent</td>
                                    <td className="px-6 py-4 border-b border-lab-muted text-lab-muted">Week 1-2</td>
                                </tr>
                                <tr className="hover:bg-lab-muted transition-colors">
                                    <td className="px-6 py-4 border-b border-lab-muted font-medium text-lab-muted">Evaluatie</td>
                                    <td className="px-6 py-4 border-b border-lab-muted text-lab-muted">Docent + ICT evalueren ervaringen</td>
                                    <td className="px-6 py-4 border-b border-lab-muted text-lab-muted">Week 3</td>
                                </tr>
                                <tr className="hover:bg-lab-muted transition-colors">
                                    <td className="px-6 py-4 border-b border-lab-muted font-medium text-lab-muted">Bredere uitrol</td>
                                    <td className="px-6 py-4 border-b border-lab-muted text-lab-muted">Meerdere klassen / jaarlagen</td>
                                    <td className="px-6 py-4 border-b border-lab-muted text-lab-muted">Week 4+</td>
                                </tr>
                                <tr className="hover:bg-lab-muted transition-colors">
                                    <td className="px-6 py-4 font-medium text-lab-muted">Schoolbreed</td>
                    ...
                    <div className="mt-6 grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div className="p-4 bg-lab-muted rounded-xl">
                            <p className="text-sm font-bold text-lab-muted mb-2">Communicatie naar leerlingen</p>
                        ...
                        <div className="p-4 bg-lab-muted rounded-xl">
                            <p className="text-sm font-bold text-lab-muted mb-2">Communicatie naar ouders</p>
                            <p className="text-xs text-lab-muted">
