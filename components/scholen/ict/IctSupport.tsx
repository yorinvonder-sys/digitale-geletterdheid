    ...
    return (
        <div className="min-h-screen bg-lab-muted py-12 px-6">
            <div className="max-w-4xl mx-auto">
                ...
                <h1 className="text-4xl font-bold text-lab-muted mb-6">Service & Support SLA</h1>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-16">
                    <div className="bg-white p-8 rounded-2xl shadow-sm border border-lab-muted">
                        <div className="flex items-center gap-3 text-indigo-600 mb-4">
                            <IconClock />
                            <h3 className="font-bold text-lab-muted">Supporturen</h3>
                        </div>
                    ...
                    <div className="bg-white p-8 rounded-2xl shadow-sm border border-lab-muted">
                        <div className="flex items-center gap-3 text-lab-sage mb-4">
                            <IconClock />
                            <h3 className="font-bold text-lab-muted">Uptime Garantie</h3>
                        </div>
                        <p className="text-sm text-lab-muted leading-relaxed">
                ...
                <section className="bg-white rounded-2xl shadow-sm border border-lab-muted overflow-hidden mb-16">
                    <div className="p-6 border-b border-lab-muted bg-lab-muted/50">
                        <h2 className="font-bold text-lab-muted">Responstijden & Prioriteiten</h2>
                    </div>
                    <div className="overflow-x-auto">
                        <table className="w-full text-left border-collapse">
                            <thead>
                                <tr className="text-xs font-bold text-lab-muted uppercase tracking-wider">
                                    <th className="px-6 py-4 border-b border-lab-muted">Prioriteit</th>
                                    <th className="px-6 py-4 border-b border-lab-muted">Omschrijving</th>
                                    <th className="px-6 py-4 border-b border-lab-muted">Eerste Reactie</th>
                                    <th className="px-6 py-4 border-b border-lab-muted">Streef-oplossing</th>
                                </tr>
                            </thead>
                            <tbody className="text-sm">
                                <tr className="hover:bg-red-50/30 transition-colors">
                                    <td className="px-6 py-4 border-b border-lab-muted"><span className="text-red-600 font-bold">P1 - Kritiek</span></td>
                                    <td className="px-6 py-4 border-b border-lab-muted text-lab-muted">Platform volledig onbereikbaar voor alle gebruikers.</td>
                                    <td className="px-6 py-4 border-b border-lab-muted font-medium text-lab-muted">binnen 2-4 uur</td>
                                    <td className="px-6 py-4 border-b border-lab-muted text-lab-muted">8 uur</td>
                                </tr>
                                <tr className="hover:bg-lab-gold/30 transition-colors">
                                    <td className="px-6 py-4 border-b border-lab-muted"><span className="text-lab-gold font-bold">P2 - Hoog</span></td>
                                    <td className="px-6 py-4 border-b border-lab-muted text-lab-muted">Kernfunctionaliteit werkt niet (bijv. inloggen faalt).</td>
                                    <td className="px-6 py-4 border-b border-lab-muted font-medium text-lab-muted">binnen 8 uur</td>
                                    <td className="px-6 py-4 border-b border-lab-muted text-lab-muted">1 werkdag</td>
                                </tr>
                                <tr className="hover:bg-blue-50/30 transition-colors">
                                    <td className="px-6 py-4 border-b border-lab-muted"><span className="text-blue-600 font-bold">P3 - Normaal</span></td>
                                    <td className="px-6 py-4 border-b border-lab-muted text-lab-muted">Vragen over gebruik, kleine bugs of wensen.</td>
                                    <td className="px-6 py-4 border-b border-lab-muted font-medium text-lab-muted">binnen 2 werkdagen</td>
                                    <td className="px-6 py-4 border-b border-lab-muted text-lab-muted">volgende release</td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
                ...
                <div className="bg-lab-muted rounded-2xl p-8 text-white">
