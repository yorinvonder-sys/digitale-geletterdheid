...
const CheckItem = ({ children }: { children: React.ReactNode }) => (
    <li className="flex items-start gap-3 py-3 border-b border-lab-muted last:border-0">
        ...
        <span className="text-lab-muted text-sm">{children}</span>
    </li>
);
...
export const ComplianceChecklist: React.FC = () => {
    ...
    return (
        <div className="min-h-screen bg-lab-muted py-20 px-6">
            <div className="max-w-2xl mx-auto bg-white p-10 rounded-3xl shadow-sm border border-lab-muted">
                <div className="flex justify-between items-start mb-8">
                    <div>
                        <h1 className="text-2xl font-bold text-lab-muted mb-2">AI-Compliance Checklist VO</h1>
                        <p className="text-lab-muted text-sm">Versie 2026.1 — DGSkills Resource</p>
                    </div>
                    <button onClick={() => window.print()} className="px-4 py-2 bg-lab-muted text-white text-xs font-bold rounded-lg hover:bg-lab-muted transition-colors no-print">
                ...
                <div className="mt-12 pt-8 border-t border-lab-muted text-center">
                    <p className="text-xs text-lab-muted mb-4 italic">Deze checklist is een hulpmiddel en vervangt geen juridisch advies van je FG.</p>
