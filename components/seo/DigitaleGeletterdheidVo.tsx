    ...
    return (
        <div className="min-h-screen bg-white">
            ...
            <main className="pt-32">
                <section className="px-6 mb-20">
                    <div className="max-w-3xl mx-auto">
                        ...
                        <div className="flex flex-wrap gap-4">
                            ...
                            <a href="/scholen" className="bg-white border border-lab-muted text-lab-muted px-8 py-4 rounded-xl font-bold hover:bg-lab-muted transition-all">
                ...
                <section className="py-20 bg-lab-muted border-y border-lab-muted px-6">
