  ...
  return (
    <div className="bg-gray-800/50 border border-gray-700/50 rounded-2xl overflow-hidden">
      ...
      {loading ? (
        ...
        <>
          {/* Summary stats */}
          <div className="px-5 py-4 flex items-center gap-6 border-b border-gray-700/30">
            <div>
              <div className="text-2xl font-black text-white">{completeCount}</div>
              <div className="text-xs text-gray-400 mt-0.5">leerlingen met beide metingen</div>
            </div>
            {hasData && !kAnonymityWarning && (
              <div>
                ...
                <div className="text-xs text-gray-400 mt-0.5">gemiddelde totaalgroei</div>
              </div>
            )}
          </div>
              ...
              <table className="w-full text-sm">
                ...
                <tbody>
                  {domeinGemiddelden.map((row, i) => (
                    <tr
                      key={row.domein}
                      className={`border-t border-gray-700/30 ${i % 2 === 0 ? '' : 'bg-gray-700/10'}`}
                    >
          ...
          {/* Footer */}
          <div className="px-5 py-3 border-t border-gray-700/30 text-xs text-gray-500">
