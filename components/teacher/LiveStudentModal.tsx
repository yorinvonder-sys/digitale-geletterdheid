...
export const LiveStudentModal: React.FC<LiveStudentModalProps> = ({ student, onClose }) => {
    ...
    return (
        <div className="fixed inset-0 z-[60] bg-black/80 backdrop-blur-md flex items-center justify-center p-4 font-mono" onClick={onClose}>
            <div className="bg-lab-muted rounded-lg shadow-2xl border border-lab-muted w-full max-w-2xl overflow-hidden flex flex-col max-h-[80vh]" onClick={e => e.stopPropagation()}>
                    ...
                    <div className="flex items-center gap-3">
                        <div className="flex items-center gap-1.5">
                            <span className="relative flex h-2 w-2">
                                <span className="animate-ping absolute inline-flex h-full w-full rounded-full bg-lab-sage opacity-75"></span>
                        ...
                        <button onClick={onClose} className="hover:bg-lab-muted p-1 rounded transition-colors text-lab-muted hover:text-white">
                            <X size={16} />
                        </button>
                    </div>
                </div>
                ...
                <div className="flex-1 overflow-y-auto p-4 space-y-2 font-mono text-xs md:text-sm bg-lab-muted text-lab-muted relative" ref={scrollRef}>
                    ...
                    {connectionStep >= 3 && (
                        <div className="mt-4 flex items-center gap-2 text-lab-sage animate-pulse">
