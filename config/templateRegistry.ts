import type { TemplateMissionEntry, TemplateType } from '@/components/missions/templates/shared/types';
...
export const TEMPLATE_MISSIONS: Record<string, TemplateMissionEntry> = {
    ...
    // === DataViewer (15) ===
    'data-journalist':      { missionId: 'data-journalist',      templateType: 'data-viewer' },
