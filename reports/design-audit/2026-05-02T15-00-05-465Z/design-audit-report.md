...
Generated: 2026-05-02T15:00:07.292Z
...
| --- | --- | ---: | --- | --- |
| `/` | desktop | 64 | partial | Body achtergrond is #faf9f0 in plaats van cream/paper/creamDeep.<br>Interactieve doelen kleiner dan 44px gevonden: a "Naar hoofdinhoud" 1x1; button "Skills" 33x20; button "Projecten" 62x20. |
| `/` | mobile | 71 | partial | Body achtergrond is #faf9f0 in plaats van cream/paper/creamDeep.<br>Interactieve doelen kleiner dan 44px gevonden: a "Naar hoofdinhoud" 1x1; a "dgskills.app" 350x20; button "Over ons" 57x20. |
| `/ict` | desktop | 12 | not-updated | Body achtergrond is #faf9f0 in plaats van cream/paper/creamDeep.<br>Weinig design.md tokengebruik zichtbaar (0 gemeten stijldeclaraties). |
| `/ict` | mobile | 15 | not-updated | Body achtergrond is #faf9f0 in plaats van cream/paper/creamDeep.<br>Weinig design.md tokengebruik zichtbaar (0 gemeten stijldeclaraties). |
...
| `/pilot` | desktop | 9 | not-updated | Body achtergrond is #faf9f0 in plaats van cream/paper/creamDeep.<br>Weinig design.md tokengebruik zichtbaar (0 gemeten stijldeclaraties). |
| `/pilot` | mobile | 9 | not-updated | Body achtergrond is #faf9f0 in plaats van cream/paper/creamDeep.<br>Weinig design.md tokengebruik zichtbaar (0 gemeten stijldeclaraties). |
| `/scholen` | desktop | 64 | partial | Body achtergrond is #faf9f0 in plaats van cream/paper/creamDeep.<br>Interactieve doelen kleiner dan 44px gevonden: a "Naar hoofdinhoud" 1x1; button "Skills" 33x20; button "Projecten" 62x20. |
| `/scholen` | mobile | 71 | partial | Body achtergrond is #faf9f0 in plaats van cream/paper/creamDeep.<br>Interactieve doelen kleiner dan 44px gevonden: a "Naar hoofdinhoud" 1x1; a "dgskills.app" 350x20; button "Over ons" 57x20. |
...
Issues:
- Body achtergrond is #faf9f0 in plaats van cream/paper/creamDeep.
- Interactieve doelen kleiner dan 44px gevonden: a "Naar hoofdinhoud" 1x1; button "Skills" 33x20; button "Projecten" 62x20.
...
Issues:
- Body achtergrond is #faf9f0 in plaats van cream/paper/creamDeep.
- Interactieve doelen kleiner dan 44px gevonden: a "Naar hoofdinhoud" 1x1; a "dgskills.app" 350x20; button "Over ons" 57x20.
...
- Interactieve doelen kleiner dan 44px gevonden: a "DGSkills" 101x32; a "Waarom DGSkills" 106x20; a "Kerndoelen" 70x20.
...
- Geen nieuw logo.svg of logo-lockup.svg in de zichtbare header gevonden.
- Interactieve doelen kleiner dan 44px gevonden: a "DGSkills" 101x32; a "info@dgskills.app" 102x16; a "Privacy" 41x16.
...
- Geen nieuw logo.svg of logo-lockup.svg in de zichtbare header gevonden.
- Interactieve doelen kleiner dan 44px gevonden: a "DGSkills" 107x32; a "Voor scholen" 86x20; input 1x1.
