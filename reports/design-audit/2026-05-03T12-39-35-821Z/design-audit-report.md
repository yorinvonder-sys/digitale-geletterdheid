...
Signalen: Outfit=true, tokengebruik=418, oude kleurclasses=0, logo=true, productbeelden=true
...
Signalen: Outfit=true, tokengebruik=456, oude kleurclasses=0, logo=true, productbeelden=true
