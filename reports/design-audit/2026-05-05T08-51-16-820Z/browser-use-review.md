...
Generated: 2026-05-05T08:51:19.973Z
...
- http://127.0.0.1:5173/ (desktop, score 89)
- http://127.0.0.1:5173/scholen (desktop, score 89)
...
| --- | ---: | --- | --- |
| `/login` | 93 | partial | Interactieve doelen kleiner dan 44px gevonden: a "Voor scholen — Digitale geletterdheid" 236x16.<br>Mogelijk afgekapt tekstblok gevonden (1 voorbeelden). |
