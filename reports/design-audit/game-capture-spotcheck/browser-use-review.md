...
| --- | ---: | --- | --- |
| `/dev/mission-capture?mission=game-programmeur` | 75 | partial | Geen nieuw logo.svg of logo-lockup.svg in de zichtbare header gevonden.<br>Beperkt design.md tokengebruik zichtbaar (40 gemeten stijldeclaraties).<br>Geen primaire DGSkills-screenshotbron uit design.md zichtbaar. |
