...
`;
  ...
  // robots.txt is statisch in public/robots.txt — Vite kopieert het automatisch naar dist/.
  // Niet hier overschrijven: dat zou de Disallow-regels voor private routes weghalen.
  console.log('  ✓ /sitemap.xml bijgewerkt (robots.txt komt uit public/)');
}
