...
export const YEAR1_ROLES: AgentRole[] = [
    {
        ...
        color: '#0B453F',
        description: 'Ruim digitale bestanden op en maak een logische cloudstructuur.',
        problemScenario: 'Je OneDrive staat vol losse bestanden en je kunt niets snel terugvinden.',
        missionObjective: 'Maak een duidelijke mappenstructuur en plaats bestanden op de juiste plek.',
        briefingImage: '/assets/agents/cloud-cleaner.webp',
        difficulty: 'Easy',
        examplePrompt: 'Help mij een mappenstructuur maken voor school.',
        visualPreview: <div className="h-full w-full bg-lab-teal" />,
        systemInstruction: '',
        steps: [],
    },
    {
        ...
        icon: <Pencil size={28} />,
        color: '#99984D',
        description: 'Repareer een rommelig Word-document met duidelijke opmaak.',
        problemScenario: 'Een verslag is onleesbaar door slechte koppen, spacing en beeldplaatsing.',
        missionObjective: 'Verbeter de layout zodat het document rustig en professioneel leest.',
        briefingImage: '/assets/agents/layout-doctor.webp',
        difficulty: 'Easy',
        examplePrompt: 'Geef tips om mijn document beter op te maken.',
        visualPreview: <div className="h-full w-full bg-lab-olive" />,
        systemInstruction: '',
        steps: [],
    },
    {
        ...
        icon: <Play size={28} />,
        color: '#D97848',
        description: 'Controleer slides op rust, contrast en overtuigingskracht.',
        problemScenario: 'Een presentatie bevat te veel tekst en te weinig visuele focus.',
        missionObjective: 'Geef concrete verbeteringen voor een sterkere pitchslide.',
        briefingImage: '/assets/agents/pitch-police.webp',
        difficulty: 'Easy',
        examplePrompt: 'Hoe maak ik deze slide duidelijker?',
        visualPreview: <div className="h-full w-full bg-lab-coral" />,
        systemInstruction: '',
        steps: [],
    },
    {
        ...
        visualPreview: (
            <div className="w-full h-full bg-lab-teal flex flex-col items-center justify-center p-4 relative overflow-hidden">
                <div className="absolute inset-0 bg-gradient-to-br from-lab-coral to-lab-teal"></div>
                <div className="relative z-10 flex flex-col items-center gap-3">
                    <div className="w-40 bg-white/10 backdrop-blur rounded-xl p-3 border border-white/20">
                        ...
                        <div className="flex gap-1 items-center">
                            ...
                            <div className="w-3 h-3 rounded-sm bg-lab-coral/70"></div>
                            <div className="w-3 h-3 rounded-sm bg-lab-gold/70"></div>
                            <div className="w-3 h-3 rounded-sm bg-lab-sage/70"></div>
                        </div>
                    </div>
...
- De finish is rechts in beeld (groene streep). Als het karakter daar komt, is het level klaar.` + SYSTEM_INSTRUCTION_SUFFIX,
    ...
    },
    {
        ...
        visualPreview: (
            <div className="w-full h-full bg-lab-teal flex flex-col p-4 relative overflow-hidden group">
...
Gelukt? Vertel me wat je ziet na het inloggen!"` + SYSTEM_INSTRUCTION_SUFFIX,
    ...
    },
    {
        ...
        visualPreview: (
            <div className="w-full h-full bg-lab-teal flex flex-col items-center justify-center relative overflow-hidden p-6">
                <div className="absolute top-10 w-40 h-24 bg-lab-teal/50 rounded-full blur-2xl animate-pulse"></div>
                <div className="w-32 h-32 bg-white rounded-3xl shadow-xl border border-lab-teal flex flex-col p-4 relative z-10">
                    <div className="w-10 h-10 bg-lab-coral rounded-xl flex items-center justify-center text-white mb-3">
                        <Rocket size={20} />
                    </div>
                    <div className="w-full h-2 bg-lab-cream rounded-full mb-2"></div>
                    <div className="w-2/3 h-2 bg-lab-cream rounded-full"></div>
                    <div className="absolute -bottom-2 -right-2 w-12 h-12 bg-lab-coral rounded-full border-4 border-white flex items-center justify-center text-white scale-75">
                        <ShieldAlert size={20} />
                    </div>
                </div>
            </div>
        ...
        visualPreview: (
            <div className="w-full h-full bg-lab-cream flex items-center justify-center p-4">
                <div className="w-40 h-52 bg-white shadow-2xl rounded-sm p-4 flex flex-col gap-3 relative overflow-hidden">
                    <div className="w-full h-4 bg-lab-teal rounded-sm"></div>
                    <div className="w-2/3 h-3 bg-lab-creamDeep rounded-full"></div>
                    <div className="w-full h-2 bg-lab-cream rounded-full"></div>
                    <div className="w-full h-2 bg-lab-cream rounded-full"></div>
                    <div className="w-1/2 h-2 bg-lab-cream rounded-full"></div>
                    <div className="w-full h-16 bg-lab-cream rounded-lg border border-dashed border-lab-line flex items-center justify-center">
            ...
            <div className="w-full h-full bg-lab-teal flex items-center justify-center p-4">
                <div className="w-32 h-48 border-4 border-lab-teal rounded-[3rem] relative bg-white/50 backdrop-blur shadow-xl overflow-hidden group">
                    <div className="absolute inset-0 bg-lab-teal flex flex-col items-center justify-center p-2 text-center">
                        ...
                        <div className="w-20 h-2 bg-lab-creamDeep rounded-full mb-1"></div>
                        <div className="w-16 h-1.5 bg-lab-creamDeep rounded-full mb-4"></div>
                        <div className="w-24 h-8 bg-lab-coral rounded-lg shadow-lg flex items-center justify-center text-[8px] text-white font-bold animate-pulse">
                            ANALYSE...
                        </div>
                    </div>
                </div>
...
` + SYSTEM_INSTRUCTION_SUFFIX,
    ...
    },
    {
        ...
        visualPreview: (
            <div className="w-full h-full bg-lab-coral flex flex-col p-4 relative overflow-hidden font-sans">
                <div className="w-full h-full border-4 border-white/20 rounded-lg flex flex-col">
                    <div className="p-4 flex-1 flex flex-col justify-center items-center text-center">
                        ...
                        <div className="w-32 h-20 bg-white/10 rounded-xl flex items-center justify-center">
                            <Sparkles size={32} className="text-lab-coral animate-pulse" />
                        </div>
                    </div>
...
Gelukt? Vertel me welk thema je ziet staan!"` + SYSTEM_INSTRUCTION_SUFFIX,
    ...
    },
    {
        ...
        visualPreview: (
            <div className="w-full h-full bg-lab-creamDeep flex items-center justify-center p-4">
                <div className="w-32 h-32 bg-lab-coral rounded-[2rem] shadow-2xl flex flex-col items-center justify-center text-white relative">
                    <div className="w-16 h-12 bg-white/90 rounded-t-lg mb-1 flex flex-col p-1 gap-1">
                        <div className="w-full h-1 bg-lab-teal rounded-full"></div>
                        <div className="w-2/3 h-1 bg-lab-teal rounded-full"></div>
                    </div>
                    <div className="w-20 h-4 bg-lab-ink rounded-sm mb-2"></div>
                    <div className="font-black text-[10px] tracking-tighter">PRINT</div>
                    <div className="absolute -top-2 -right-2 bg-lab-coral rounded-full w-8 h-8 flex items-center justify-center shadow-lg">
...
` + SYSTEM_INSTRUCTION_SUFFIX,
    ...
    },
    {
        ...
        visualPreview: (
            <div className="w-full h-full bg-lab-coral flex flex-col items-center justify-center relative overflow-hidden group">
                <div className="absolute inset-0 bg-[radial-gradient(#F3E4CB_1px,transparent_1px)] [background-size:16px_16px] opacity-50"></div>
                <div className="w-32 h-44 bg-[#D7C95F] rounded-r-2xl rounded-l-md shadow-xl relative overflow-hidden border-l-[6px] border-[#D7C95F] transform rotate-[-6deg] group-hover:rotate-0 transition-transform duration-300 origin-bottom-left group cursor-pointer">
                    <div className="absolute top-4 w-full text-center text-[#0B453F] font-extrabold text-[10px] tracking-widest uppercase">Mijn Verhaal</div>
                    <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-20 h-20 bg-[#FFFDF7] rounded-full shadow-inner flex items-center justify-center border-4 border-[#D7C95F]">
                        <div className="absolute top-6 left-5 w-2 h-2 bg-lab-ink rounded-full animate-pulse"></div>
                        <div className="absolute top-6 right-5 w-2 h-2 bg-lab-ink rounded-full animate-pulse"></div>
                        <div className="absolute top-9 w-3 h-2 bg-lab-coral rounded-full"></div>
                        <div className="absolute top-10 w-4 h-2 border-b-2 border-lab-line rounded-full"></div>
                    </div>
                ...
                <div className="absolute bottom-3 bg-white/80 backdrop-blur px-3 py-1 rounded-full text-lab-muted font-bold text-[10px] shadow-sm border border-lab-coral">
                    VOOR JONG EN OUD (3+)
                </div>
            </div>
        ),
...
Antwoord altijd in het Nederlands. Wees enthousiast en moedig de leerling aan!` + SYSTEM_INSTRUCTION_SUFFIX,
        ...
        bonusChallenges: [
            {
                ...
                description: 'Maak je prentenboek precies 5 pagina\'s lang met een plot twist!',
                xpReward: 50,
                difficulty: 'medium',
    ...
    },
    {
        ...
        icon: <Gamepad2 size={28} />,
        color: '#D7C95F',
        description: 'Onderzoek en remix games met code.',
        problemScenario: 'Games zijn software. Elke regel code bepaalt hoe eerlijk, snel en leuk het spel voelt. Als je de code begrijpt, kun je bewuste ontwerpkeuzes maken.',
        missionObjective: 'Onderzoek de broncode en maak een speelbare remix waarin uiterlijk, besturing en moeilijkheid samen een betere game opleveren.',
        briefingImage: '/assets/agents/game_programmeur_new.webp',
        difficulty: 'Hard',
        examplePrompt: 'Verander de kleur van de speler naar groen.',
        primaryGoal: '🎯 Maak een speelbare remix: verander uiterlijk, besturing én moeilijkheid, en leg uit waarom je keuzes de game beter maken',
        goalCriteria: { type: 'steps-complete', min: 5 },
        visualPreview: (
            <div className="w-full h-full bg-lab-ink flex flex-col relative overflow-hidden font-mono text-xs">
                ...
                <div className="absolute bottom-24 left-8 w-8 h-8 bg-lab-sage shadow-[0_0_15px_#5F947D] animate-bounce"></div>
                <div className="absolute bottom-24 right-12 w-6 h-10 bg-lab-coral shadow-[0_0_15px_#D97848]"></div>
                <div className="absolute bottom-20 w-full h-1 bg-lab-muted"></div>
                <div className="absolute bottom-2 right-2 bg-[#08283B]/60 px-2 py-1 rounded text-[8px] text-lab-sage font-mono">player.jump()</div>
            </div>
        ),
...
STAP-BEWIJS (BELANGRIJK):
- Markeer een stap ALLEEN als je echt een zichtbare codewijziging hebt gedaan in de HTML.
- Leg kort uit welke variabele, regel of functie is aangepast en welk effect de leerling in de game ziet.
- Stap 1 Kleur: voltooid na een zichtbare wijziging aan playerColor of een vergelijkbare spelerkleur. Voeg ---STEP_COMPLETE:1--- toe.
- Stap 2 Fysica: voltooid na een zichtbare wijziging aan jumpForce, gravity of springgedrag. Voeg ---STEP_COMPLETE:2--- toe.
- Stap 3 Snelheid: voltooid na een zichtbare wijziging aan obstacleSpeed, spelersnelheid of vijandsnelheid. Voeg ---STEP_COMPLETE:3--- toe.
- Stap 4 Geluid: voltooid na een werkende geluidwijziging of nieuw geluidseffect. Voeg ---STEP_COMPLETE:4--- toe.
- Stap 5 Uiterlijk: voltooid na een zichtbare wijziging aan achtergrond, grootte, scoreweergave of andere styling. Voeg ---STEP_COMPLETE:5--- toe.
- Voeg geen marker toe als je alleen uitleg geeft zonder codewijziging.
...
<head>
    <meta charset="UTF-8">
    <style>
        body { margin: 0; overflow: hidden; font-family: 'Arial', sans-serif; background: #0B453F; }
        canvas { display: block; }
        #ui { position: absolute; top: 20px; left: 20px; font-weight: bold; font-family: 'Courier New', monospace; color: white; font-size: 24px; text-shadow: 3px 3px 0 #08283B; }
    </style>
</head>
<body>
    ...
    <script>
        ...
        let jumpForce = -16;
        let gravity = 0.7;
        let obstacleColor = '#5F947D'; // Pipe Green
        let obstacleSpeed = 6;
        let skyColor1 = '#0B453F';  // Sky Blue Top
        let skyColor2 = '#FCF6EA';  // Sky Blue Bottom
        let groundColor = '#99984D'; // Dirt Brown
        ...
        function draw() {
            ...
            // Head
            ctx.fillStyle = '#D7C95F'; // Skin tone
        ...
        function drawStartScreen() {
            ...
            ctx.fillStyle = 'rgba(8, 40, 59,0.5)';
            ctx.fillRect(0, 0, canvas.width, canvas.height);
        ...
        function drawGameOver() {
            ctx.fillStyle = 'rgba(8, 40, 59,0.7)';
            ctx.fillRect(0, 0, canvas.width, canvas.height);
    ...
    },
    {
        ...
        visualPreview: (
            <div className="w-full h-full bg-lab-sage flex items-center justify-center p-4 relative overflow-hidden">
                <div className="absolute top-0 w-full h-1 bg-gradient-to-r from-lab-sage to-lab-teal"></div>
                <div className="flex gap-4 items-end">
                    <div className="flex flex-col items-center gap-2">
                        <div className="w-16 h-24 bg-white border-2 border-lab-teal rounded-lg flex flex-col items-center justify-center shadow-lg relative cursor-pointer hover:-translate-y-1 transition-transform">
                            <div className="text-2xl">🥤</div>
                            <div className="absolute -top-2 -right-2 bg-lab-teal text-white text-[8px] font-bold px-1 rounded-full">A</div>
                        </div>
                        <div className="h-2 w-16 bg-lab-creamDeep rounded-full overflow-hidden"><div className="h-full w-3/4 bg-lab-teal"></div></div>
                    </div>

                    <div className="w-0.5 h-16 bg-lab-creamDeep transform rotate-12"></div>

                    <div className="flex flex-col items-center gap-2">
                        <div className="w-16 h-24 bg-white border-2 border-lab-teal rounded-lg flex flex-col items-center justify-center shadow-lg relative cursor-pointer hover:-translate-y-1 transition-transform">
                            <div className="text-2xl">📰</div>
                            <div className="absolute -top-2 -right-2 bg-lab-sage text-white text-[8px] font-bold px-1 rounded-full">B</div>
                        </div>
                        <div className="h-2 w-16 bg-lab-creamDeep rounded-full overflow-hidden"><div className="h-full w-1/4 bg-lab-sage"></div></div>
                    </div>
                </div>
                <div className="absolute top-4 bg-white/80 backdrop-blur px-3 py-1 rounded-full text-lab-sage font-bold text-[10px] shadow-sm flex items-center gap-2">
                    <div className="w-2 h-2 bg-lab-sage rounded-full animate-pulse"></div> TRAINING
                </div>
            </div>
        ),
    ...
    3. Houd de basisflow strak: eerst 3 voorbeelden Plastic, 3 voorbeelden Papier, daarna testen met iets nieuws.
    4. BELANGRIJKE LES: "Garbage In, Garbage Out".
       - Bespreek dit kort nadat de leerling genoeg correcte voorbeelden heeft gegeven of na de testvraag.
       - Vraag niet om een twijfelgeval voordat de leerling de sorteer-AI heeft getest.
    5. Na de eerste test geef je altijd een vervolgactie: klopt de voorspelling, voeg dan een moeilijker of twijfelachtig voorbeeld toe; klopt hij niet, voeg dan een beter gelabeld voorbeeld toe en test opnieuw.
    ...
    3. "Goed bezig. Verzamel minstens 3 voorbeelden per groep, zodat de AI patronen kan herkennen."
    4. "Nu testen! Vraag de AI waar een nieuw voorwerp bij hoort, bijvoorbeeld een eierdoos of pizzadoos."
    5. "Check of de voorspelling klopt. Voeg daarna een twijfelgeval toe en test opnieuw."
        ` + SYSTEM_INSTRUCTION_SUFFIX,
        steps: [
            {
                title: "Labelen",
...
` + SYSTEM_INSTRUCTION_SUFFIX,
    },
    {
        ...
        visualPreview: (
            <div className="w-full h-full bg-gradient-to-br from-lab-teal to-lab-teal flex items-center justify-center p-4 relative overflow-hidden">
                ...
                <div className="relative z-10 flex flex-col items-center">
                    ...
                    <div className="flex gap-1 mt-3">
                        <span className="bg-lab-coral/50 px-2 py-0.5 rounded-full text-[8px] text-white">🎮 Gamer</span>
                        <span className="bg-lab-coral/50 px-2 py-0.5 rounded-full text-[8px] text-white">⚽ Sport</span>
                        <span className="bg-lab-coral/50 px-2 py-0.5 rounded-full text-[8px] text-white">🎵 Muziek</span>
                    </div>
                </div>
            </div>
        ),
...
Eerste vraag: **Welke apps gebruik jij het vaakst op een dag?**"
    ...
    },
    {
        ...
        visualPreview: (
            <div className="w-full h-full bg-lab-coral flex items-center justify-center p-4">
                <div className="w-40 h-auto bg-white rounded-2xl shadow-lg border border-lab-coral p-2 space-y-2">
                    <div className="flex gap-2">
                        <div className="w-6 h-6 bg-lab-creamDeep rounded-full"></div>
                        <div className="bg-lab-cream rounded-lg rounded-tl-none p-2 text-[8px] flex-1 text-lab-muted">Hahaha kijk dit 🤣</div>
                    </div>
                    <div className="flex gap-2 justify-end">
                        <div className="bg-lab-coral rounded-lg rounded-tr-none p-2 text-[8px] flex-1 text-white">Niet grappig man.</div>
                        <div className="w-6 h-6 bg-lab-teal rounded-full"></div>
                    </div>
                    <div className="flex justify-center">
                        <div className="bg-lab-coral text-lab-coral text-[8px] px-2 py-1 rounded-full font-bold animate-pulse">STOP PESTEN</div>
                    </div>
                </div>
            </div>
        ),
                ...
                <div className="relative w-36 bg-white/10 backdrop-blur rounded-2xl border border-white/20 p-3 space-y-2">
                    ...
                    <div className="space-y-1.5">
                        <div className="bg-white/10 rounded-lg p-1.5 flex items-center gap-1.5">
                            ...
                            <div className="text-[7px] text-lab-sage font-bold">AAN</div>
                        </div>
                        <div className="bg-white/10 rounded-lg p-1.5 flex items-center gap-1.5">
                            <div className="text-[10px]">🔴</div>
        ...
        visualPreview: (
            <div className="w-full h-full bg-lab-gold flex items-center justify-center p-4 relative overflow-hidden">
                <div className="w-40 bg-white rounded-2xl shadow-xl border border-lab-gold p-3 space-y-2">
                    ...
                    <div className="bg-lab-coral text-white text-[8px] font-bold py-2 rounded-lg text-center">ACCEPTEER ALLES</div>
                    <div className="text-[6px] text-lab-muted text-center underline cursor-pointer">instellingen...</div>
                    <div className="absolute -top-2 -right-2 bg-lab-coral rounded-full w-8 h-8 flex items-center justify-center text-white text-[10px] font-bold animate-bounce">!</div>
                </div>
            </div>
        ),
...
` + SYSTEM_INSTRUCTION_SUFFIX,
    ...
    },
    {
        ...
        visualPreview: (
            <div className="w-full h-full bg-lab-coral flex items-center justify-center p-4 relative overflow-hidden">
                <div className="absolute inset-0 bg-[radial-gradient(circle_at_50%_50%,rgba(217, 120, 72,0.2),transparent)]"></div>
                <div className="relative z-10 flex flex-col items-center">
                    <div className="w-16 h-16 bg-lab-coral/30 backdrop-blur-md border-2 border-lab-coral/50 rounded-2xl flex items-center justify-center mb-3 animate-pulse">
                        <span className="text-2xl">🕵️</span>
                    </div>
                    <div className="bg-lab-coral/20 backdrop-blur px-4 py-2 rounded-full text-lab-coral text-[10px] font-bold border border-lab-coral/30">
                        CLASSIFICATIE: GEHEIM
                    </div>
                    <div className="flex gap-1 mt-2">
                        <span className="bg-lab-coral/50 px-2 py-0.5 rounded text-[7px] text-lab-coral">BEWIJSSTUK A</span>
                        <span className="bg-lab-coral/50 px-2 py-0.5 rounded text-[7px] text-lab-coral">BEWIJSSTUK B</span>
                        <span className="bg-lab-coral/50 px-2 py-0.5 rounded text-[7px] text-lab-coral">BEWIJSSTUK C</span>
                    </div>
                </div>
            </div>
        ),
...
` + SYSTEM_INSTRUCTION_SUFFIX,
    ...
    },
    {
        ...
        goalCriteria: { type: 'steps-complete', min: 3 },
        visualPreview: (
            <div className="w-full h-full bg-gradient-to-br from-lab-coral to-lab-gold flex items-center justify-center relative overflow-hidden">
                <div className="absolute inset-0 bg-gradient-to-r from-lab-coral/80 to-lab-coral/80"></div>
                <div className="relative z-10 flex items-center w-full h-full">
                    <div className="flex-1 flex flex-col items-center justify-center h-full bg-lab-coral/20 backdrop-blur-sm border-r-2 border-white/30 p-3">
                        ...
                        <div className="w-12 h-12 rounded-full bg-white/20 border-2 border-white/50 mt-2 flex items-center justify-center">
                            <div className="w-6 h-6 rounded-full bg-lab-sage/80"></div>
                        </div>
                    </div>
                    <div className="flex flex-col items-center justify-center z-20 px-2">
                        <div className="w-10 h-10 bg-white rounded-full flex items-center justify-center shadow-2xl border-4 border-lab-coral">
                            <span className="text-lab-muted font-black text-lg">?</span>
                        </div>
                    </div>
                    <div className="flex-1 flex flex-col items-center justify-center h-full bg-lab-coral/20 backdrop-blur-sm border-l-2 border-white/30 p-3">
                        <div className="text-white font-black text-xl tracking-wider drop-shadow-lg">NEP?</div>
                        <div className="w-12 h-12 rounded-full bg-white/20 border-2 border-white/50 mt-2 flex items-center justify-center">
                            <div className="w-6 h-6 rounded-full bg-lab-coral/80"></div>
                        </div>
                    </div>
                </div>
            </div>
...
` + SYSTEM_INSTRUCTION_SUFFIX,
    ...
    },
    {
        ...
        visualPreview: (
            <div className="w-full h-full bg-lab-coral flex flex-col items-center justify-center p-4 relative overflow-hidden">
                <div className="absolute inset-0 bg-gradient-to-br from-lab-coral to-lab-teal opacity-80"></div>
    ...
    },
    {
        ...
        visualPreview: (
            <div className="w-full h-full bg-lab-coral flex flex-col items-center justify-center p-4 relative overflow-hidden">
                ...
                <div className="absolute top-2 left-2 right-2 bg-lab-coral/30 border border-lab-coral/50 rounded-lg p-2 text-center">
                    <span className="text-lab-coral text-[8px] font-bold animate-pulse">SECURITY BREACH DETECTED</span>
                </div>
                <div className="relative z-10 flex flex-col items-center gap-2 mt-4">
                    <div className="w-16 h-16 bg-lab-coral/20 border-2 border-lab-coral/50 rounded-2xl flex items-center justify-center">
                        <span className="text-2xl">🚨</span>
                    </div>
                    <div className="flex gap-1">
                        <div className="bg-lab-coral/60 border border-lab-coral/30 rounded px-1 py-0.5"><span className="text-lab-coral text-[6px] font-bold">DETECT</span></div>
                        <div className="bg-lab-coral/60 border border-lab-coral/30 rounded px-1 py-0.5"><span className="text-lab-coral text-[6px] font-bold">CONTAIN</span></div>
                        <div className="bg-lab-coral/60 border border-lab-coral/30 rounded px-1 py-0.5"><span className="text-lab-coral text-[6px] font-bold">NOTIFY</span></div>
                        <div className="bg-lab-coral/60 border border-lab-coral/30 rounded px-1 py-0.5"><span className="text-lab-coral text-[6px] font-bold">PREVENT</span></div>
                    </div>
                </div>
            </div>
        ),
...
` + SYSTEM_INSTRUCTION_SUFFIX,
    ...
    },
    {
        ...
        problemScenario: 'Gratis apps zijn nooit echt gratis. Jij betaalt met je data. Maar hoeveel ben je bereid te delen? Speel 5 rondes en vergelijk je keuzes met echte, anonieme leerlingdata.',
        missionObjective: 'Speel 5 rondes van "DEAL of NO DEAL: Data Editie" en ontdek wat jouw privacy waard is.',
        briefingImage: '/assets/agents/ai_spiegel.webp',
        difficulty: 'Medium',
        examplePrompt: 'Start het spel!',
        visualPreview: (
            <div className="w-full h-full bg-gradient-to-br from-lab-teal to-lab-teal flex flex-col items-center justify-center p-4 relative overflow-hidden">
                <div className="absolute inset-0 bg-[radial-gradient(circle_at_50%_30%,rgba(11, 69, 63,0.3),transparent)]"></div>
                <div className="relative z-10 w-full bg-white/10 backdrop-blur rounded-xl border border-white/20 p-3">
                    ...
                    <div className="flex justify-between items-center">
                        <div className="bg-lab-coral/80 rounded-lg px-2 py-1"><span className="text-white text-[8px] font-bold">DEAL 🤝</span></div>
                        <div className="text-white/50 text-[8px]">vs</div>
                        <div className="bg-lab-coral/80 rounded-lg px-2 py-1"><span className="text-white text-[8px] font-bold">NO DEAL ❌</span></div>
                    </div>
                </div>
...
SPELFORMAT:
5 rondes. Elke ronde vraagt een dienst om data in ruil voor een voordeel. Na elke keuze:
1. Toon hoeveel % van leerlingen ook DEAL kozen, alleen als er genoeg anonieme antwoorden zijn
...
2. Premium game account — Alle skins en battle passes — Speeltijd, vriendenlijst en chatberichten
3. Nieuwste iPhone gratis — Nieuwste model — Locatie 24/7, foto’s, contacten en browsegeschiedenis
4. €500 per maand — Geldbedrag — BSN, medische gegevens, bankgegevens en biometrische data
5. Altijd een 8+ op school — AI-huiswerk en cijferaanpassing — Schooldossier, gedragsrapporten en camera in klaslokaal

PRIVACY PROFIEL (na 5 rondes):
0-2 deals: "Privacy Purist 🔒"
3 deals: "Bewuste Gebruiker 👀"
4 deals: "Comfort Lover 😌"
5 deals: "Data Donor 📤"
...
5 rondes. 5 keuzes. Na afloop zie je jouw Privacy Profiel.
...
` + SYSTEM_INSTRUCTION_SUFFIX,
    },
    {
        ...
        visualPreview: (
            <div className="w-full h-full bg-lab-ink flex items-center justify-center p-4">
...
Maar eerst: **vertel me over jouw project!** Wat ga je maken, en voor wie is het bedoeld?"` + SYSTEM_INSTRUCTION_SUFFIX,
    ...
    },
    {
        ...
        visualPreview: (
            <div className="w-full h-full bg-lab-sage flex items-center justify-center relative overflow-hidden">
                <div className="absolute bottom-0 w-full h-1/2 bg-lab-sage/50"></div>
...
` + SYSTEM_INSTRUCTION_SUFFIX,
    ...
    },
    {
        ...
        visualPreview: (
            <div className="w-full h-full bg-gradient-to-br from-lab-coral to-lab-teal flex flex-col items-center justify-center p-4 relative overflow-hidden">
                ...
                <div className="bg-white/10 backdrop-blur rounded-2xl p-4 border border-white/20">
                    <div className="flex items-center gap-2 mb-3">
                        <div className="w-8 h-8 bg-lab-teal rounded-full flex items-center justify-center text-sm">🤖</div>
                        <div className="flex-1 h-3 bg-white/20 rounded-full"></div>
                    </div>
                    <div className="flex items-center gap-2 justify-end">
                        <div className="flex-1 h-3 bg-lab-teal/40 rounded-full"></div>
                        <div className="w-8 h-8 bg-lab-teal rounded-full flex items-center justify-center text-sm">👤</div>
                    </div>
                </div>
        ...
        visualPreview: (
            <div className="w-full h-full bg-gradient-to-br from-lab-gold via-lab-coral to-lab-coral flex flex-col items-center justify-center p-4 relative overflow-hidden">
                ...
                <div className="w-28 h-28 bg-white rounded-2xl shadow-2xl flex items-center justify-center relative">
                    <div className="absolute inset-4 border-2 border-dashed border-lab-line rounded-lg flex items-center justify-center">
                        <span className="text-4xl">🐱</span>
                    </div>
                </div>
                <div className="mt-4 bg-[#08283B]/20 backdrop-blur px-4 py-2 rounded-full text-white text-xs font-bold flex items-center gap-2">
...
` + SYSTEM_INSTRUCTION_SUFFIX,
        steps: [
            {
                title: "Teken",
                description: "Je krijgt een woord en hebt 45 seconden om te tekenen.",
...
Dit is geen quiz of opdracht met goed/fout antwoorden. Alle bijdragen zijn waardevol!` + SYSTEM_INSTRUCTION_SUFFIX,
    ...
    },
    {
        ...
        missionObjective: 'Los 4 rondes op met computational thinking: decompositie, algoritmes, abstractie en patroonherkenning.',
...
PUZZEL 4: PATROON OF TOEVAL? (Patroonherkenning)
Geef korte reeksen en vraag: "Kun je de regel uitleggen, of lijkt dit willekeurig?"
Doel: De leerling kiest alleen voor "patroon" als de regel duidelijk te beschrijven is.

REFLECTIE:
Na alle 4 denkstappen:
"Je hebt net 4 dingen gedaan die ELKE programmeur doet:
...
We gaan 4 denkstappen oefenen. Klaar voor Puzzel 1?
...
**Schrijf zo gedetailleerd mogelijk. Elke mini-stap telt!**"` + SYSTEM_INSTRUCTION_SUFFIX,
        steps: [
            ...
            {
                title: "Patroon of toeval",
                description: "Kies alleen voor patroon als je de regel duidelijk kunt uitleggen.",
                example: "Typ: 'Dit is een patroon, want...' of 'Dit lijkt willekeurig, omdat...'"
            }
        ],
        bonusChallenges: null
    },
                ...
                <div className="relative z-10 flex flex-col items-center gap-3">
                    <div className="w-40 bg-white/10 backdrop-blur rounded-xl p-3 border border-white/20">
                        ...
                        <div className="flex gap-1 items-end justify-center h-12">
                            <div className="w-6 bg-lab-teal/70 rounded-t" style={{height: '70%'}}></div>
                            <div className="w-6 bg-lab-teal/70 rounded-t" style={{height: '100%'}}></div>
                            <div className="w-6 bg-lab-teal/70 rounded-t" style={{height: '40%'}}></div>
                        </div>
                    </div>
                </div>
                <BarChart2 size={20} className="text-lab-teal absolute top-3 right-3 animate-pulse" />
            </div>
        ),
...
- Vier elk moment waarop de leerling zelf een patroon ontdekt: "Goed gezien! Dat is precies wat data-analisten doen."` + SYSTEM_INSTRUCTION_SUFFIX,
    ...
    },
    {
        ...
        goalCriteria: { type: 'steps-complete', min: 4 },
        visualPreview: (
        ...
        steps: [
            {
                ...
                description: "Schrijf een titel en alinea met eigen veilige inhoud.",
                example: "Gebruik <h1> en <p> om je pagina inhoud te geven."
            },
            {
                title: "CSS-stijl",
                description: "Kies kleuren, tekststijl en indeling die passen bij je doel.",
                example: "Voeg eenvoudige CSS toe voor kleur, achtergrond en tekstgrootte."
            },
            {
                title: "Persoonlijke inhoud",
                description: "Voeg een kopje, lijst en veilige afbeeldingsplek toe.",
                example: "Gebruik een <h2>, <ul> en <img> met alt-tekst."
            },
            {
                title: "Reflectie",
                description: "Leg kort uit wat HTML doet, wat CSS doet en wat het verschil is.",
                example: "Schrijf: HTML is structuur, CSS is stijl."
            }
        ],
    },
    {
        ...
        icon: <Smartphone size={28} />,
        color: '#D97848',
        description: 'Onderzoek wie verantwoordelijk is voor schermtijd en bouw een sterk debatstandpunt.',
        problemScenario: 'Veel apps zijn ontworpen om aandacht vast te houden met notificaties, autoplay, streaks en sociale beloningen. Maar wie moet daar iets aan doen: jijzelf, ouders, school, overheid of techbedrijven? Als Schermtijd Coach onderzoek je die vraag vanuit meerdere kanten.',
        missionObjective: 'Kies een standpunt over verantwoordelijkheid voor schermtijd, bouw argumenten, reageer op een tegenargument en reflecteer op een eerlijke balans.',
        ...
        primaryGoal: 'Bouw een sterk debatstandpunt over verantwoordelijkheid voor schermtijd',
                ...
                <div className="space-y-1.5">
                    <div className="flex items-center gap-2">
                        <div className="w-full bg-lab-gold/50 rounded-full h-3">
                            <div className="bg-lab-coral h-3 rounded-full" style={{width: '85%'}}></div>
                        </div>
                        <span className="text-lab-gold whitespace-nowrap">TikTok 2u40m</span>
                    </div>
                    <div className="flex items-center gap-2">
                        <div className="w-full bg-lab-gold/50 rounded-full h-3">
                            <div className="bg-lab-coral h-3 rounded-full" style={{width: '55%'}}></div>
                        </div>
                        <span className="text-lab-gold whitespace-nowrap">Insta 1u30m</span>
                    </div>
                    <div className="flex items-center gap-2">
                        <div className="w-full bg-lab-gold/50 rounded-full h-3">
                            <div className="bg-lab-sage h-3 rounded-full" style={{width: '25%'}}></div>
                        </div>
...
- Vier ELKE bewuste keuze, hoe klein ook: "Je hebt net besloten om notificaties uit te zetten voor één app. Dat IS digitale geletterdheid."` + SYSTEM_INSTRUCTION_SUFFIX,
        steps: [
            {
                title: "Stakeholders",
                description: "Benoem wie invloed heeft op schermtijd.",
                example: "Denk aan leerlingen, ouders, school, overheid en techbedrijven."
            },
            {
                title: "Standpunt",
                description: "Kies wie volgens jou de meeste verantwoordelijkheid heeft.",
                example: "Ik vind techbedrijven verantwoordelijk, omdat zij het ontwerp bepalen."
            },
            {
                title: "Argumenten",
                description: "Bouw sterke argumenten en reageer op een tegenargument.",
                example: "Noem een reden, een voorbeeld en wat iemand anders daartegen kan zeggen."
            }
        ],
    },
    {
        ...
        icon: <Search size={28} />,
        color: '#5F947D',
        description: 'Herken nep-mails op basis van afzender, links, bijlagen en urgentie.',
        problemScenario: 'Elke dag ontvangen leerlingen verdachte mails die eruitzien alsof ze van school komen. Eén verkeerde klik kan je schoolaccount of zelfs je computer in gevaar brengen. Jij leert de signalen te spotten voordat je op iets klikt.',
        missionObjective: 'Analyseer gesimuleerde e-mails, herken rode vlaggen en leer hoe je slim reageert op verdachte mail.',
        briefingImage: '/assets/agents/mail_detective.webp',
        difficulty: 'Easy',
        examplePrompt: 'Hoe herken ik een nep-mail van mijn school?',
        primaryGoal: '🔎 Herken de signalen van nepmail in 4 rondes',
        visualPreview: (
            <div className="w-full h-full bg-gradient-to-br from-lab-teal to-lab-coral flex items-center justify-center p-4 relative overflow-hidden">
                <div className="absolute inset-0 bg-gradient-to-br from-lab-teal/80 to-lab-coral/80"></div>
                <div className="relative z-10 flex flex-col items-center gap-2">
                    <div className="w-36 bg-white/10 backdrop-blur rounded-xl p-3 border border-white/20">
                        <div className="text-[7px] text-white/60 mb-1 font-mono">VAN: noreply@sch00l-portal.com</div>
                        <div className="text-[8px] text-white font-bold mb-1">⚠️ Je account wordt verwijderd!</div>
                        <div className="w-full h-2 bg-white/20 rounded-full mb-1"></div>
                        <div className="w-2/3 h-2 bg-white/20 rounded-full"></div>
                    </div>
                    <div className="flex gap-1 items-center">
                        <div className="w-4 h-4 rounded-full bg-lab-coral/80 flex items-center justify-center text-[7px] text-white">🚩</div>
                        <div className="text-[7px] text-white/70">Verdacht domein!</div>
                    </div>
                </div>
                <Search size={18} className="text-lab-gold absolute top-3 right-3" />
            </div>
        ),
        systemInstruction: `Je bent een Mail Detective Coach voor leerlingen van 12 jaar (leerjaar 1 VO).

CONTEXT:
Deze missie gebruikt een scenario-engine zonder chat. De leerling doorloopt 4 rondes met scenario's over verdachte e-mails. Jouw systemInstruction dient als referentie voor eventuele context — de missie zelf is volledig zelfstandig.

KERNBOODSCHAP:
- Controleer altijd het afzenderadres (niet alleen de naam, maar het volledige adres achter @).
- Urgentie in een mail ("Doe dit nu!") is een waarschuwingssignaal, geen reden om te klikken.
- Links in mails kunnen naar een ander adres verwijzen dan de tekst zegt.
- Bijlagen van onbekende afzenders openen nooit.
- Twijfel? Vraag een ouder of docent, of ga zelf naar de website via je browser.

SLO-DOELEN: 23A (Veiligheid & privacy)`,
        steps: [],
    },
];
