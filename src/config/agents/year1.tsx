    ...
    },
    {
        ...
        visualPreview: (
            <div className="w-full h-full bg-lab-coral flex flex-col items-center justify-center relative overflow-hidden group">
                ...
                <div className="w-32 h-44 bg-duck-acid rounded-r-2xl rounded-l-md shadow-xl relative overflow-hidden border-l-[6px] border-duck-acid transform rotate-[-6deg] group-hover:rotate-0 transition-transform duration-300 origin-bottom-left group cursor-pointer">
                    <div className="absolute top-4 w-full text-center text-duck-ink font-extrabold text-[10px] tracking-widest uppercase">Mijn Verhaal</div>
                    <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-20 h-20 bg-white rounded-full shadow-inner flex items-center justify-center border-4 border-duck-acid">
                    ...
                    <div className="absolute bottom-4 left-0 w-full flex justify-center gap-1">
                        <div className="w-16 h-1 bg-duck-acid rounded-full opacity-50"></div>
                    </div>
                </div>
...
Antwoord altijd in het Nederlands. Wees enthousiast en moedig de leerling aan!` + SYSTEM_INSTRUCTION_SUFFIX,
    ...
    },
    {
        ...
        primaryGoal: '🎯 Ik maak een speelbare remix: verander uiterlijk, besturing én moeilijkheid, en leg uit waarom mijn keuzes de game beter maken',
        ...
        visualPreview: (
            <div className="w-full h-full bg-lab-ink flex flex-col relative overflow-hidden font-mono text-xs">
                ...
                <div className="absolute bottom-2 right-2 bg-duck-ink/60 px-2 py-1 rounded text-[8px] text-lab-sage font-mono">player.jump()</div>
            </div>
        ),
...
` + SYSTEM_INSTRUCTION_SUFFIX,
    ...
    },
    {
        ...
        icon: <Scale size={28} />,
        color: '#ff3c21', // Violet for Ethics/Wisdom
...
- Vier ELKE bewuste keuze, hoe klein ook: "Je hebt net besloten om notificaties uit te zetten voor één app. Dat IS digitale geletterdheid."` + SYSTEM_INSTRUCTION_SUFFIX,
    ...
    },
    {
        ...
        primaryGoal: '🔎 Ik herken de signalen van nepmail in 4 rondes',
        visualPreview: (
            <div className="w-full h-full bg-gradient-to-br from-lab-teal to-lab-coral flex items-center justify-center p-4 relative overflow-hidden">
