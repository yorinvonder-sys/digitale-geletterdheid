...
export const MISSION_PREVIEW_OVERRIDES: Record<string, Partial<MissionPreviewConfig>> = {
    ...
    'ipad-print-instructies': { kind: 'print', title: 'Print Troubleshooter', subtitle: 'Vijf printproblemen herkennen en oplossen', chips: ['Printer', 'Instellingen', 'Oplossen'], accent: STUDENT_DASHBOARD_COLORS.ink, surface: STUDENT_DASHBOARD_COLORS.creamDeep },
    ...
    'layout-doctor': { kind: 'document', title: 'Word layout repareren', subtitle: 'Tekstomloop, Kop 1, inhoudsopgave en paginanummers', chips: ['Word', 'Kop 1', 'Layout'], accent: STUDENT_DASHBOARD_COLORS.ink, surface: STUDENT_DASHBOARD_COLORS.paper },
