...
export const KERNDOEL_MISSIONS: KerndoelMissionMeta[] = [
  ...
  { id: 'sustainability-scanner', title: 'Trend Scanner', week: 4, yearGroup: 2, sloKerndoelen: ['21C'], sloVsoKerndoelen: ['18B'] },                  // data lezen, berekenen en observaties onderbouwen
  { id: 'eindproject-j2', title: 'Eindproject Jaar 2', week: 4, yearGroup: 2, sloKerndoelen: ['21C'], sloVsoKerndoelen: ['18B'] }, // data-analyse als voorbereiding, geen volledige capstone
