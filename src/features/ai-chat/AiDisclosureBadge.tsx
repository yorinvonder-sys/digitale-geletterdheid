...
export const AiDisclosureBadge: React.FC<AiDisclosureBadgeProps> = ({
    ...
    return (
        <div
            className={`inline-flex items-center gap-1.5 px-2.5 py-1 bg-lab-teal border border-lab-teal
                        rounded-lg text-xs text-lab-teal font-medium ${className}`}
            role="note"
            aria-label="AI-gegenereerde inhoud"
        >
            <Sparkles size={12} className="text-lab-muted shrink-0" />
