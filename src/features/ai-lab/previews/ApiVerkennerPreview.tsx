...
const ApiVerkennerPreview: React.FC = () => {
    ...
    return (
        <div className="w-full h-full bg-gradient-to-br from-lab-teal to-white flex flex-col overflow-hidden">
            {/* Header */}
            <div className="shrink-0 bg-gradient-to-r from-lab-teal to-lab-teal px-4 py-3 flex items-center gap-2">
            ...
            <div className="flex-1 overflow-y-auto p-4 space-y-3 min-h-0">
                ...
                <div className="flex gap-2">
                    {API_EXAMPLES.map((api, i) => (
                        <button
                            ...
                            className={`flex-1 px-3 py-2 rounded-xl text-xs font-bold transition-all ${selectedApi === i ? 'bg-lab-teal text-white ring-2 ring-lab-teal shadow-sm' : 'bg-white text-lab-muted border border-lab-line hover:bg-lab-teal hover:text-white'}`}
                        >
                ...
                {/* Request */}
                <div className="bg-lab-ink rounded-xl overflow-hidden shadow-lg">
                    <div className="px-3 py-2 bg-lab-ink flex items-center justify-between">
                        <div className="flex items-center gap-2">
                            <span className="bg-lab-coral text-white text-[9px] font-black px-2 py-0.5 rounded">GET</span>
                    ...
                    <div className="px-3 py-2 flex items-center gap-2">
                        ...
                        <button
                            onClick={handleSend}
                            className="shrink-0 bg-lab-teal hover:bg-lab-coral hover:text-white text-white p-2 rounded-lg transition-colors"
                        >
                ...
                <div className="bg-lab-ink rounded-xl overflow-hidden shadow-lg">
                    <div className="px-3 py-2 bg-lab-ink flex items-center justify-between">
                        <div className="flex items-center gap-2">
                            {showResponse ? (
                                <span className="bg-lab-coral text-white text-[9px] font-black px-2 py-0.5 rounded">200 OK</span>
                            ) : (
