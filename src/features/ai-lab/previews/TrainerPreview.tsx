...
const StartButton: React.FC<{ onStart: () => void; countdown: number }> = ({ onStart, countdown }) => {
    ...
    return (
        <button
            ...
            `}
            style={{
                backgroundColor: isReady ? AI_TRAINER_ACCENT : '#E7D8BD',
        ...
        return (
            <div className="w-full h-full flex flex-col relative overflow-hidden" style={{ backgroundColor: '#FCF6EA' }}>
                ...
                <div className="flex-1 flex flex-col items-center justify-start p-4 md:p-5 relative z-10 overflow-y-auto">
                    ...
                    <p className="text-center max-w-md mb-3 leading-snug text-xs md:text-sm" style={{ color: '#445865' }}>
                    ...
                    <div className="rounded-2xl p-3.5 max-w-lg w-full mb-3" style={{ backgroundColor: '#FFFFFF', border: '1px solid #E7D8BD' }}>
                        ...
                        <p className="text-xs md:text-sm mb-3 leading-snug" style={{ color: '#445865' }}>
                        ...
                        <div className="space-y-2">
                            ...
                            <div className="grid grid-cols-2 gap-2">
                                <div className="rounded-xl p-2.5" style={{ backgroundColor: '#FCF6EA', border: '1px solid #E7D8BD' }}>
                                    <div className="flex items-center gap-2 mb-1.5">
                                        ...
                                        <span className="font-bold text-xs" style={{ color: '#08283B' }}>Voorbeeld plastic</span>
                                    </div>
                                    <p className="text-xs font-mono ml-7 leading-snug" style={{ color: PLASTIC_ACCENT }}>"Een flesje is plastic"</p>
                                </div>
                                <div className="rounded-xl p-2.5" style={{ backgroundColor: '#FCF6EA', border: '1px solid #E7D8BD' }}>
                                    <div className="flex items-center gap-2 mb-1.5">
                                        <span className="rounded-full w-5 h-5 flex items-center justify-center shrink-0 font-bold text-[11px] text-white" style={{ backgroundColor: '#5F947D' }}>2</span>
                                        <span className="font-bold text-xs" style={{ color: '#08283B' }}>Voorbeeld papier</span>
                                    </div>
                                    <p className="text-xs font-mono ml-7 leading-snug" style={{ color: '#5F947D' }}>"Een krant is papier"</p>
                                </div>
                            </div>
                            ...
                            <div className="grid grid-cols-2 gap-2">
                                <div className="rounded-xl p-2.5" style={{ backgroundColor: '#FCF6EA', border: '1px solid #E7D8BD' }}>
                                    <div className="flex items-center gap-2 mb-1.5">
                                        <span className="rounded-full w-5 h-5 flex items-center justify-center shrink-0 font-bold text-[11px] text-white" style={{ backgroundColor: '#0B453F' }}>3</span>
                                        <span className="font-bold text-xs" style={{ color: '#08283B' }}>Herhaal</span>
                                    </div>
                                    <p className="text-[11px] ml-7 leading-snug" style={{ color: '#445865' }}>
                                        Minstens 3 per bak
                                    </p>
                                </div>
                                <div className="rounded-xl p-2.5" style={{ backgroundColor: '#FCF6EA', border: '1px solid #E7D8BD' }}>
                                    <div className="flex items-center gap-2 mb-1.5">
                                        <span className="rounded-full w-5 h-5 flex items-center justify-center shrink-0 font-bold text-[11px] text-white" style={{ backgroundColor: '#5F947D' }}>4</span>
                                        <span className="font-bold text-xs" style={{ color: '#08283B' }}>Test de AI</span>
                                    </div>
                                    <p className="text-xs font-mono ml-7 leading-snug" style={{ color: '#5F947D' }}>"Waar hoort een eierdoos bij?"</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="rounded-xl p-2.5 max-w-lg w-full mb-3" style={{ backgroundColor: AI_TRAINER_ACCENT_SOFT, border: `1px solid ${AI_TRAINER_ACCENT_BORDER}` }}>
                        <p className="text-xs text-center leading-snug" style={{ color: '#445865' }}>
                ...
                <div className="mx-4 mt-4 rounded-2xl p-3 shadow-sm" style={{ backgroundColor: '#FFFFFF', border: '1px solid #E7D8BD' }}>
                    <div className="flex items-start gap-3">
                        ...
                        <div>
                            ...
                            <div className="rounded-lg px-3 py-2 space-y-1" style={{ backgroundColor: '#FCF6EA', border: '1px solid #E7D8BD' }}>
            ...
            <div className="flex-1 flex flex-col p-4 md:p-6 gap-6 overflow-y-auto min-h-0">
                    ...
                    <div className="flex items-start gap-3">
                        <div className="relative shrink-0">
                            <div className="w-16 h-16 rounded-2xl flex items-center justify-center" style={{ backgroundColor: 'rgba(95, 148, 125, 0.08)', border: '2px solid rgba(95, 148, 125, 0.22)' }}>
                                <Database size={28} style={{ color: '#0B453F' }} />
                            </div>
                            <div className="absolute -right-2 -bottom-2 w-7 h-7 rounded-full flex items-center justify-center text-white text-xs font-black" style={{ backgroundColor: hasBalancedDataset ? '#5F947D' : '#D97848' }}>
                                {totalTrainingItems}
                            </div>
                        </div>
                        <div className="flex-1 min-w-0">
                            <h4 className="font-black text-sm mb-1" style={{ color: '#08283B' }}>AI-robot training</h4>
                            <p className="text-xs leading-relaxed mb-3" style={{ color: '#445865' }}>
                            ...
                            <div className="grid grid-cols-3 gap-2">
                                {trainingSteps.map(step => (
                                    <div key={step.label} className="rounded-xl p-2" style={{ backgroundColor: step.done ? 'rgba(95, 148, 125, 0.08)' : '#FCF6EA', border: `1px solid ${step.done ? 'rgba(95, 148, 125, 0.25)' : '#E7D8BD'}` }}>
                                        <div className="flex items-center gap-1.5 mb-1">
                                            {step.done ? <Check size={13} style={{ color: '#5F947D' }} /> : <Sparkles size={13} style={{ color: '#D97848' }} />}
                                            <span className="text-[10px] font-black uppercase" style={{ color: step.done ? '#5F947D' : '#445865' }}>{step.value}</span>
                        </div>
                                        <p className="text-[11px] leading-tight" style={{ color: '#445865' }}>{step.label}</p>
                                    </div>
                                ))}
                            </div>
                        </div>
                ...
                {hasBalancedDataset && !data.testItem && (
                    <div className="mx-2 rounded-lg p-2 text-center" style={{ backgroundColor: AI_TRAINER_ACCENT_SOFT, border: `1px solid ${AI_TRAINER_ACCENT_BORDER}` }}>
                        <p className="text-xs" style={{ color: '#5F947D' }}>Je dataset is sterk genoeg. <strong>Test nu de AI</strong> met iets nieuws, bijvoorbeeld: <em>"Waar hoort een eierdoos bij?"</em></p>
                    </div>
                )}
                    ...
                    <div className="rounded-2xl p-4 flex flex-col relative" style={{ backgroundColor: 'rgba(95, 148, 125, 0.04)', border: '2px solid rgba(95, 148, 125, 0.2)' }}>
                        ...
                        <div className="mt-4 flex-1 space-y-2 overflow-y-auto custom-scrollbar pr-1">
                            ...
                            {needsPaperExamples && data.classBItems.length > 0 && data.classBItems.length < 2 && (
                                <div className="rounded-lg p-2 text-center text-xs" style={{ backgroundColor: 'rgba(95, 148, 125, 0.06)', border: '1px dashed rgba(95, 148, 125, 0.3)', color: '#5F947D' }}>
                                    Typ nog een papier voorbeeld in de chat!
                                </div>
                            )}
                            {data.classBItems.map((item, i) => (
                                <div key={i} className="text-sm px-3 py-2 rounded-lg animate-in zoom-in slide-in-from-top-2 duration-300 flex items-center gap-2" style={{ backgroundColor: 'rgba(95, 148, 125, 0.08)', border: '1px solid rgba(95, 148, 125, 0.2)', color: '#5F947D' }}>
                ...
                <div className="rounded-2xl p-4 relative min-h-[100px] flex items-center justify-between gap-4 shrink-0 z-10" style={{ backgroundColor: '#FFFFFF', border: '1px solid #E7D8BD' }}>
                    ...
                    {data.testItem ? (
                        <>
                            <div className="flex-1 min-w-0">
                                <p className="text-[10px] font-black uppercase tracking-wider mb-1" style={{ color: '#445865' }}>Nieuw testvoorwerp</p>
                                <div className="font-bold px-4 py-3 rounded-xl shadow-sm text-base animate-in slide-in-from-left" style={{ backgroundColor: '#FCF6EA', color: '#08283B', border: '1px solid #E7D8BD' }}>
                                    "{data.testItem.name}"
                                </div>
                            </div>
                            ...
                            <div className="flex-1 min-w-0">
                                <p className="text-[10px] font-black uppercase tracking-wider mb-1" style={{ color: '#445865' }}>Voorspelling van jouw AI</p>
                                ...
                                <p className="text-[11px] mt-2 leading-snug" style={{ color: '#445865' }}>
