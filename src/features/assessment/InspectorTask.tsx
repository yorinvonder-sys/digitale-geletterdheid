...
export const InspectorTask: React.FC<Props> = ({ task, onComplete }) => {
            ...
            <div className="absolute inset-0 bg-white flex flex-col">
                ...
                <div className="flex-1 flex flex-col px-4 py-3 gap-3 overflow-hidden">
                    ...
                    <div className="flex flex-col items-start">
                        <div className="bg-lab-bg border border-lab-line px-3 py-2 rounded-2xl rounded-tl-sm max-w-[55%] shadow-sm">
                    ...
                    <div className="flex items-center gap-2 my-0.5">
                        <div className="flex-1 border-t border-lab-line"></div>
    ...
    return (
        <div className="flex flex-col h-full bg-lab-bg text-lab-dark p-4">
            ...
            <div className="flex-1 relative flex items-center justify-center bg-white rounded-2xl overflow-hidden border border-lab-line shadow-sm">
                        ...
                        {task.image === 'SPECIAL:BAD_SLIDE' && (
                            ...
                            >
                                <div className="absolute inset-0 bg-white p-8 flex flex-col pointer-events-none select-none overflow-hidden relative">
                                    <div className="absolute inset-0 bg-[conic-gradient(at_top_right,_var(--tw-gradient-stops))] from-lab-coral via-lab-coral to-lab-coral opacity-20"></div>
                                    <h1 className="text-6xl font-bold mb-4 text-lab-coral font-serif drop-shadow-md z-10" style={{ fontFamily: '"Comic Sans MS", "Chalkboard SE", sans-serif' }}>
                                        MIJN SPREEKBEURT OVER KATTEN!!!
                                    </h1>
                                    <div className="bg-lab-teal p-4 border-4 border-lab-teal z-10 text-[10px] leading-tight text-lab-teal font-mono">
            ...
            <div className="mt-3 bg-white p-4 rounded-xl border border-lab-line shadow-sm">
