      ...
      >
        ...
        <div className="text-center space-y-2">
          <motion.h1
            ...
            className="text-2xl font-black text-lab-ink tracking-tight"
          >
        ...
        <motion.div
          ...
          className="bg-white border border-lab-line rounded-2xl p-4 shadow-sm"
        >
        ...
        >
          {DOMEINEN.map((domein, i) => {
            ...
            return (
              <div
                key={domein.key}
                className="flex items-center gap-3 bg-white border border-lab-line rounded-xl px-4 py-3 shadow-sm"
              >
                ...
                <div className={`text-sm font-black ${scores[i] >= 80 ? 'text-lab-sage' : scores[i] >= 50 ? 'text-lab-coral' : 'text-lab-teal'}`}>
                  {scores[i]}
                </div>
              </div>
            );
        ...
        <motion.button
          ...
          onClick={onContinue}
          className="w-full flex items-center justify-center gap-2 py-4 bg-lab-coral hover:bg-lab-coral hover:text-white text-white font-black rounded-2xl text-sm transition-all shadow-lg shadow-lab-coral hover:brightness-110 active:scale-[0.98]"
        >
