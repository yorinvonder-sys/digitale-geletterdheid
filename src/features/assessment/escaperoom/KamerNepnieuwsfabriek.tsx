    ...
    >
          ...
          {berichten.map((_, i) => (
            <div
              ...
              className={`w-2 h-2 rounded-full transition-colors ${
                i < huidigIndex ? 'bg-lab-coral' : i === huidigIndex ? 'bg-lab-coral ring-2 ring-lab-sage' : 'bg-lab-creamDeep'
              }`}
            />
          ))}
        </div>
      ...
      <div className="flex-1 flex items-center justify-center">
        <AnimatePresence mode="wait">
          ...
          >
            <div className="bg-white rounded-xl border border-lab-line shadow-sm overflow-hidden">
              {/* Bron */}
              <div className="px-4 py-2 bg-lab-cream border-b border-lab-line flex items-center justify-between">
              ...
              {/* Content */}
              <div className="p-5">
                <h3 className="text-lg font-bold text-lab-ink mb-3">{huidigBericht.titel}</h3>
            ...
            <div className="mt-4 flex gap-3">
              {!heeftGeantwoord ? (
                ...
                <button
                  ...
                  className="flex-1 py-3 rounded-xl font-bold text-sm bg-lab-sage hover:bg-lab-sage hover:text-white text-white transition-all active:scale-[0.98] flex items-center justify-center gap-2 shadow-lg shadow-lab-sage"
                >
