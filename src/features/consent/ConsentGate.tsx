...
export const ConsentGate: React.FC<ConsentGateProps> = ({
  ...
  return (
    <div className="flex flex-col items-center justify-center p-8 text-center max-w-md mx-auto">
      ...
      <h3 className="text-lg font-bold text-lab-ink mb-2">Toestemming nodig</h3>
      ...
      {onRequestConsent && (
        <button
          ...
          className="px-6 py-2.5 bg-lab-coral text-white rounded-xl text-sm font-semibold hover:bg-lab-coral hover:text-white transition-colors flex items-center gap-2"
        >
          <ShieldCheck size={16} />
          Toestemming geven
        </button>
