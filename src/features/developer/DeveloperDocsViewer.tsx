...
export function DeveloperDocsViewer() {
  return (
    <div className="space-y-6 animate-in fade-in duration-300">
      <div className="bg-white rounded-3xl border border-duck-line shadow-sm p-8 md:p-10">
        <div className="w-14 h-14 rounded-2xl bg-duck-acid text-duck-ink flex items-center justify-center mb-6">
          <Lock size={28} />
        </div>
        <h2 className="text-2xl font-black text-duck-ink mb-3">Interne documentatie is uit de publieke build gehaald</h2>
        <p className="text-sm text-duck-muted leading-relaxed max-w-2xl">
      ...
      <div className="bg-duck-ink rounded-3xl p-8 border border-duck-line flex items-start gap-4">
        <div className="w-12 h-12 rounded-2xl bg-white/10 text-duck-ink flex items-center justify-center shrink-0">
          <ShieldAlert size={24} />
        </div>
