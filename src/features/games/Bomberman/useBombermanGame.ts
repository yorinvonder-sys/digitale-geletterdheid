    ...
    useEffect(() => {
        const joinGame = async () => {
            try {
                ...
                const currentPlayers = (roomData?.players as unknown as Record<string, Player>) || {};
                ...
                if (initialRoom) {
                    ...
                    setGameState({
                        ...
                        grid: parsedGrid,
                        players: (initialRoom.players || {}) as unknown as Record<string, Player>,
                        bombs: (initialRoom.bombs || {}) as unknown as Record<string, Bomb>,
