        ...
        <div className="w-full h-full flex flex-col" style={{ backgroundColor: '#FCF6EA' }}>
            ...
            <div className="flex-1 p-4 overflow-auto">
                {isLoading ? (
                    ...
                    <div className="flex flex-col items-center justify-center h-full text-center p-6">
                        <div className="w-24 h-24 rounded-full flex items-center justify-center mb-6" style={{ backgroundColor: '#E7D8BD' }}>
                                ...
                                <button
                                    ...
                                    style={
                                        pendingChallenge === classmate.uid
                                            ? { backgroundColor: 'rgba(217, 120, 72,0.15)', color: '#D97848', cursor: 'wait' }
                                            : pendingChallenge
                                                ? { backgroundColor: '#E7D8BD', color: '#445865', cursor: 'not-allowed' }
