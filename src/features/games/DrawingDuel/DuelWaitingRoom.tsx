        ...
        <div className="w-full h-full flex flex-col" style={{ backgroundColor: '#FCF6EA', color: '#08283B' }}>
            ...
            <div className="flex-1 flex flex-col items-center justify-center p-8 gap-8">
                ...
                <div className="flex items-center gap-12">
                    ...
                    >
                        ...
                        {opponentReady ? (
                            ...
                            <div className="absolute -top-2 -right-2 w-10 h-10 rounded-full flex items-center justify-center shadow-lg" style={{ backgroundColor: '#E7D8BD' }}>
                ...
                {readCountdown > 0 && !myReady ? (
                    <div className="mt-8 px-12 py-5 rounded-2xl font-bold text-lg flex items-center justify-center gap-3" style={{ backgroundColor: '#E7D8BD', color: '#445865', border: '1px solid #E7D8BD', fontFamily: "'Outfit', system-ui, sans-serif" }}>
                    ...
                    <button
                        ...
                        style={myReady
                            ? { backgroundColor: '#E7D8BD', color: '#445865', fontFamily: "'Outfit', system-ui, sans-serif" }
