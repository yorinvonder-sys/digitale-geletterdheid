        ...
        return (
            <div className="min-h-screen bg-[#FCF6EA] overflow-y-auto p-4 pb-safe">
                <div className="max-w-3xl mx-auto">
                    ...
                    <div className="flex bg-[#E7D8BD] p-1 rounded-full mb-6 max-w-sm mx-auto">
            ...
            <div className="min-h-screen bg-[#FCF6EA] overflow-y-auto p-4 pb-safe">
                <div className="max-w-lg mx-auto space-y-6">
                    ...
                    <button
                        ...
                        className={`w-full py-4 rounded-full font-black text-lg transition-all duration-300 active:scale-95 shadow-xl flex items-center justify-center gap-2 focus-visible:ring-2 focus-visible:ring-[#D97848] ${analyzeResponse.trim().length < 10 ? 'bg-[#E7D8BD] text-[#445865] shadow-none cursor-not-allowed' : 'bg-[#D97848] text-white hover:bg-[#D97848] shadow-[#D97848]/30'}`}
                    >
                ...
                <div className="max-w-lg mx-auto">
                    ...
                    <div className="space-y-3">
                        {ch.options.map((opt, i) => {
                            ...
                            else if (done) bg = 'bg-[#E7D8BD] border-[#E7D8BD] opacity-50';
                            return (<button key={i} onClick={() => handleAnswer(i)} disabled={done} className={`w-full p-4 rounded-2xl border-2 text-left transition-all duration-300 ${bg}`}>
                                <div className="flex items-start gap-3">
                                    <div className={`w-7 h-7 rounded-lg flex items-center justify-center flex-shrink-0 text-xs font-black ${done && isCorrect ? 'bg-[#5F947D] text-white' : done && isSelected ? 'bg-lab-coral text-white' : 'bg-[#E7D8BD] text-[#445865]'}`}>{done && isCorrect ? <Check size={14} /> : done && isSelected ? <X size={14} /> : String.fromCharCode(65 + i)}</div>
