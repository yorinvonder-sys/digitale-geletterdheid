...
export const CodeBlock: React.FC<CodeBlockProps> = ({
    ...
    return (
        ...
        >
            {/* Main block */}
            <div
                className="flex items-center gap-2 px-3 py-2 rounded-lg shadow-md border-2 border-[#08283B]/20 text-white font-bold text-sm select-none transition-transform hover:scale-[1.02]"
            ...
            {definition.hasBody && !isInPalette && (
                <div className="ml-4 mt-1 relative">
                    ...
                    >
                        {children || (
                            <div className="text-xs text-duck-ink/60 italic text-center py-2">
...
export const DraggablePaletteBlock: React.FC<DraggableBlockProps> = ({ definition, onDragStart }) => {
    ...
    const handleTouchStart = (e: React.TouchEvent) => {
        ...
        clone.style.boxShadow = '0 10px 30px rgba(8, 40, 59,0.3)';
