...
export const apiArchitectConfig: BuilderCanvasConfig = {
    ...
    experienceDesign: {
        boringRisk: 'medium',
        firstTenSeconds: 'Endpoint testbench: leerling kiest direct welke API-call als eerste moet werken.',
        primaryInteraction: 'test-product',
        feedbackMoment: 'Na de testkeuze koppelt feedback endpoint, HTTP-methode, statuscode en beveiliging aan het API-ontwerp.',
        visualKit: 'maker-canvas',
        evidenceMoment: 'De leerling levert endpointtabel, authenticatiekeuze en twee testbare API-docs als productbewijs.',
        antiBoringRule: 'API-ontwerp voelt als een werkende contracttest tussen frontend en backend, niet als losse endpointlijst.',
        chromeAcceptance: 'Testbench-start, API-stappen, tekstvelden en completionbewijs blijven bruikbaar op desktop, tablet portrait, tablet landscape en mobile.',
    },
    enableChat: true,
