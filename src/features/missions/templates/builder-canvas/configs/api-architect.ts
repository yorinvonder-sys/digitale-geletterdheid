...
export const apiArchitectConfig: BuilderCanvasConfig = {
    ...
    maxScore: 100,
    badges: [
        { minScore: 90, emoji: '🏆', title: 'API Master', color: '#e1ff01' },
        { minScore: 70, emoji: '🔌', title: 'Backend Architect', color: '#202023' },
        { minScore: 50, emoji: '📡', title: 'Endpoint Builder', color: '#ff3c21' },
        { minScore: 25, emoji: '💡', title: 'Beginnende API Bouwer', color: '#202023' },
