...
export const appPrototyperConfig: BuilderCanvasConfig = {
    ...
    experienceDesign: {
        boringRisk: 'medium',
        firstTenSeconds: 'Prototype challenge: leerling kiest welk schoolprobleem eerst als klikbare flow getest wordt.',
        primaryInteraction: 'test-product',
        feedbackMoment: 'Na de prototypekeuze koppelt feedback probleem, wireframe, gebruikersflow en testplan aan elkaar.',
        visualKit: 'maker-canvas',
        evidenceMoment: 'De leerling onderbouwt probleem, drie wireframes, flow en testplan als toetsbaar prototypebewijs.',
        antiBoringRule: 'Appontwerp start met een gebruikersprobleem en testbare flow, niet met schermen verzinnen voor de sier.',
        chromeAcceptance: 'Prototype-start, wireframe-stappen, flowbewijs en testplan passen zonder overflow op alle vier viewports.',
    },
    enableChat: true,
