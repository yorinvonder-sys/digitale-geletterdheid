...
export const automationEngineerConfig: BuilderCanvasConfig = {
    ...
    experienceDesign: {
        boringRisk: 'medium',
        firstTenSeconds: 'Dry-run console: leerling kiest welke saaie taak veilig geautomatiseerd kan worden.',
        primaryInteraction: 'test-product',
        feedbackMoment: 'Na de dry-run koppelt feedback taakstappen, pseudocode, risico en veilige testaanpak aan de automatisering.',
        visualKit: 'maker-canvas',
        evidenceMoment: 'De leerling levert taakanalyse, scriptstructuur en dry-run testplan als bewijs dat automatisering veilig is.',
        antiBoringRule: 'Automatiseren wordt een veilige test-run met consequenties, niet alleen pseudocode opschrijven.',
        chromeAcceptance: 'Dry-run start, pseudocodevelden en testbewijs blijven duidelijk en tappable op desktop, tablet portrait, tablet landscape en mobile.',
    },
    enableChat: true,
