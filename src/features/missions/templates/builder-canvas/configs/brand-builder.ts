...
export const brandBuilderConfig: BuilderCanvasConfig = {
    ...
    experienceDesign: {
        boringRisk: 'medium',
        firstTenSeconds: 'Brand lab: leerling kiest eerst welke eerste indruk het merk moet oproepen.',
        primaryInteraction: 'test-product',
        feedbackMoment: 'Na de merkkeuze koppelt feedback doelgroep, merkwoorden, kleur en logo-concept aan consistentie.',
        visualKit: 'maker-canvas',
        evidenceMoment: 'De leerling levert merkpersoonlijkheid, kleurenpalet, logo-uitleg en huisstijlgids als testbaar merkbewijs.',
        antiBoringRule: 'Merken bouwen begint met een eerste-indruk test en doelgroep, niet met willekeurige kleuren kiezen.',
        chromeAcceptance: 'Brand-start, canvasstappen, preview en completionbewijs blijven visueel strak op alle vier viewports.',
    },
    enableChat: true,
