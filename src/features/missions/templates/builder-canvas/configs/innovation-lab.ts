...
export const innovationLabConfig: BuilderCanvasConfig = {
    ...
    experienceDesign: {
        boringRisk: 'medium',
        firstTenSeconds: 'Impact prototype brief: leerling kiest welk SDG-probleem een eerste MVP-test verdient.',
        primaryInteraction: 'test-product',
        feedbackMoment: 'Na de MVP-keuze koppelt feedback probleem, gebruiker, kernfunctie en impactmeting aan elkaar.',
        visualKit: 'maker-canvas',
        evidenceMoment: 'De leerling levert probleemkader, technologische oplossing, MVP en impactpresentatie als innovatiebewijs.',
        antiBoringRule: 'Innovatie start met een concreet probleem en testbare MVP, niet met grote wereldverbeterwoorden.',
        chromeAcceptance: 'MVP-start, SDG-context, prototypebewijs en impactstap blijven rustig en responsive op alle vier viewports.',
    },
    enableChat: true,
