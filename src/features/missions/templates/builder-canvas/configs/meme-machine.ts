...
export const memeMachineConfig: BuilderCanvasConfig = {
    ...
    experienceDesign: {
        boringRisk: 'medium',
        firstTenSeconds: 'Share test: leerling kiest welk meme-idee grappig blijft zonder iemand te raken.',
        primaryInteraction: 'test-product',
        feedbackMoment: 'Na de share test koppelt feedback format, herkenbaarheid, boodschap en schadelijkheidsgrens aan elkaar.',
        visualKit: 'maker-canvas',
        evidenceMoment: 'De leerling onderbouwt format-analyse, eigen meme, deelbaarheid en grens tussen humor en schade.',
        antiBoringRule: 'Meme maken wordt een verantwoord content-testmoment, niet alleen iets grappigs invullen.',
        chromeAcceptance: 'Share test, contentcopy en veiligheidsreflectie blijven niet-kwetsend en responsive op alle vier viewports.',
    },
    enableChat: true,
