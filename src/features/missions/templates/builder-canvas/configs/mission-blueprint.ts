...
export const missionBlueprintConfig: BuilderCanvasConfig = {
    ...
    experienceDesign: {
        boringRisk: 'medium',
        firstTenSeconds: 'Blueprint sprint: leerling kiest welke mijlpaal het project als eerste testbaar maakt.',
        primaryInteraction: 'test-product',
        feedbackMoment: 'Na de mijlpaalkeuze koppelt feedback scope, volgorde, risico en opleverbewijs aan de planning.',
        visualKit: 'maker-canvas',
        evidenceMoment: 'De leerling levert projectscope, planning, prioriteiten en testbare mijlpalen als blauwdrukbewijs.',
        antiBoringRule: 'Projectplanning wordt een maakbare sprintkaart met testmomenten, geen statische takenlijst.',
        chromeAcceptance: 'Blueprint-start, planningstappen, voortgang en bewijsstatus blijven zonder clipping op alle vier viewports.',
    },
    enableChat: true,
    ...
    maxScore: 100,
    badges: [
        { minScore: 90, emoji: '🏆', title: 'Projectmanager', color: '#D7C95F' },
        { minScore: 70, emoji: '🗺️', title: 'Planner', color: '#5F947D' },
        { minScore: 50, emoji: '📋', title: 'Takenlijst Maker', color: '#D97848' },
        { minScore: 25, emoji: '💡', title: 'Beginnende Planner', color: '#0B453F' },
