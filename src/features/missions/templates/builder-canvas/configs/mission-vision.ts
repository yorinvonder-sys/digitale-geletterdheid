...
export const missionVisionConfig: BuilderCanvasConfig = {
    ...
    experienceDesign: {
        boringRisk: 'medium',
        firstTenSeconds: 'Vision board: leerling kiest welk toekomstbeeld de eerste slide moet bewijzen.',
        primaryInteraction: 'test-product',
        feedbackMoment: 'Na de vision-keuze koppelt feedback woorden, moodboard, slides en pitch aan een duidelijke boodschap.',
        visualKit: 'maker-canvas',
        evidenceMoment: 'De leerling levert visie, moodboard, slides en korte pitch als visueel productbewijs.',
        antiBoringRule: 'Visie bouwen draait om een testbare eerste indruk, niet om decoratief moodboarden zonder boodschap.',
        chromeAcceptance: 'Vision-start, moodboardstappen, tekstvelden en pitchbewijs blijven visueel helder op alle vier viewports.',
    },
    enableChat: true,
    ...
    maxScore: 100,
    badges: [
        { minScore: 90, emoji: '🏆', title: 'Visionair', color: '#D7C95F' },
        { minScore: 70, emoji: '💡', title: 'Ideeënspreker', color: '#5F947D' },
        { minScore: 50, emoji: '🎨', title: 'Moodboard Maker', color: '#D97848' },
        { minScore: 25, emoji: '💡', title: 'Beginnende Visionair', color: '#0B453F' },
