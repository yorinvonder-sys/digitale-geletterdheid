...
export const openSourceContributorConfig: BuilderCanvasConfig = {
    ...
    experienceDesign: {
        boringRisk: 'medium',
        firstTenSeconds: 'Issue triage: leerling kiest welke bugfix veilig genoeg is voor een eerste pull request.',
        primaryInteraction: 'test-product',
        feedbackMoment: 'Na de issuekeuze koppelt feedback workflow, buganalyse, testgeval en PR-tekst aan professioneel samenwerken.',
        visualKit: 'maker-canvas',
        evidenceMoment: 'De leerling levert Git-workflow, sorteerfix, testvoorbeeld en PR-beschrijving als contributorbewijs.',
        antiBoringRule: 'Open source voelt als echte reviewbare bijdrage met test, niet als Git-commando’s overschrijven.',
        chromeAcceptance: 'Issue-start, code/testvelden en PR-bewijs blijven leesbaar en zonder horizontale overflow op alle vier viewports.',
    },
    enableChat: false,
