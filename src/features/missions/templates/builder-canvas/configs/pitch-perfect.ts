...
export const pitchPerfectConfig: BuilderCanvasConfig = {
    ...
    maxScore: 100,
    badges: [
        { minScore: 90, emoji: '🏆', title: 'Pitch Perfect', color: '#e1ff01' },
        { minScore: 70, emoji: '🎤', title: 'Overtuigend Spreker', color: '#202023' },
        { minScore: 50, emoji: '🗣️', title: 'Pitch Beginner', color: '#ff3c21' },
        { minScore: 25, emoji: '💡', title: 'Beginnende Pitcher', color: '#202023' },
