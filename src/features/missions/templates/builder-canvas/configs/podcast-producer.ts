...
export const podcastProducerConfig: BuilderCanvasConfig = {
    ...
    experienceDesign: {
        boringRisk: 'medium',
        firstTenSeconds: 'Cold open test: leerling kiest welke eerste zin luisteraars direct laat blijven.',
        primaryInteraction: 'test-product',
        feedbackMoment: 'Na de cold open koppelt feedback doelgroep, structuur, intro en interviewvragen aan luisterwaarde.',
        visualKit: 'maker-canvas',
        evidenceMoment: 'De leerling levert onderwerpkeuze, podcaststructuur, openingszin en interviewvragen als productbewijs.',
        antiBoringRule: 'Podcast maken start met luisteraarstest en audioflow, niet met een onderwerp invullen.',
        chromeAcceptance: 'Cold-open start, structuurstappen en tekstvelden blijven overzichtelijk en mobiel bruikbaar.',
    },
    enableChat: true,
