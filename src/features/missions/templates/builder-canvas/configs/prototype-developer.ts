...
export const prototypeDeveloperConfig: BuilderCanvasConfig = {
    ...
    maxScore: 100,
    badges: [
        { minScore: 90, emoji: '🏆', title: 'Prototype Master', color: '#e1ff01' },
        { minScore: 70, emoji: '🛠️', title: 'Builder', color: '#202023' },
        { minScore: 50, emoji: '🔧', title: 'Maker', color: '#ff3c21' },
        { minScore: 25, emoji: '💡', title: 'Beginnende Prototype Bouwer', color: '#202023' },
