...
export const startupSimulatorConfig: BuilderCanvasConfig = {
    ...
    maxScore: 100,
    badges: [
        { minScore: 90, emoji: '🏆', title: 'Startup Founder', color: '#e1ff01' },
        { minScore: 70, emoji: '🚀', title: 'Tech Entrepreneur', color: '#202023' },
        { minScore: 50, emoji: '💡', title: 'Ideeënmachine', color: '#ff3c21' },
        { minScore: 25, emoji: '🌱', title: 'Beginnende Ondernemer', color: '#202023' },
