...
export const startupSimulatorConfig: BuilderCanvasConfig = {
    ...
    experienceDesign: {
        boringRisk: 'medium',
        firstTenSeconds: 'Founder test: leerling kiest welk probleem dringend genoeg is voor een startup.',
        primaryInteraction: 'test-product',
        feedbackMoment: 'Na de founder test koppelt feedback probleem, oplossing, businessmodel en pitch aan marktbewijs.',
        visualKit: 'maker-canvas',
        evidenceMoment: 'De leerling levert probleemverhaal, doelgroep, businessmodel, concurrentieanalyse en pitchstructuur.',
        antiBoringRule: 'Startupwerk begint met probleemvalidatie en pitchtest, niet met een fantasienaam voor een bedrijf.',
        chromeAcceptance: 'Founder-start, businessmodelstappen en pitchbewijs blijven scanbaar en zonder overflow op alle vier viewports.',
    },
    enableChat: true,
