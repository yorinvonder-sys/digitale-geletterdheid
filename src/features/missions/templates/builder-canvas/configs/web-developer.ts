...
export const webDeveloperConfig: BuilderCanvasConfig = {
    ...
    experienceDesign: {
        boringRisk: 'medium',
        firstTenSeconds: 'Web preview test: leerling kiest welke interactie als eerste moet werken op de dierenasielpagina.',
        primaryInteraction: 'test-product',
        feedbackMoment: 'Na de previewtest koppelt feedback HTML-structuur, CSS-layout, JavaScript-gedrag en testscenario aan UX.',
        visualKit: 'maker-canvas',
        evidenceMoment: 'De leerling levert paginastructuur, responsive layout, interactie en testplan als webproductbewijs.',
        antiBoringRule: 'Webontwikkeling draait om een werkende en geteste interactie, niet om codeblokken invullen.',
        chromeAcceptance: 'Preview-start, codebeschrijvingen, testplan en completionbewijs blijven bruikbaar op desktop, tablet portrait, tablet landscape en mobile.',
    },
    enableChat: true,
