...
export const websiteBouwerConfig: BuilderCanvasConfig = {
    ...
    missionGoal: {
        ...
        criteria: {
            type: 'steps-complete',
            min: 4,
            description: 'Alle vier builder-stappen zijn afgerond met checklistbewijs en eigen tekst.',
        },
        evidence: 'HTML-basis, CSS-stijl, persoonlijke inhoud en uitleg over HTML versus CSS.',
    },
    introFeatures: [
    ...
    experienceDesign: {
        boringRisk: 'medium',
        firstTenSeconds: 'Browser reveal: leerling kiest welke Over Mij-sectie als eerste zichtbaar moet zijn.',
        primaryInteraction: 'test-product',
        feedbackMoment: 'Na de browser reveal koppelt feedback HTML, CSS, persoonlijke inhoud en browsergedrag aan de webpagina.',
        visualKit: 'maker-canvas',
        evidenceMoment: 'De leerling levert HTML-basis, CSS-stijl, persoonlijke inhoud en uitleg over browserweergave.',
        antiBoringRule: 'De eerste website voelt als iets dat in een browser tot leven komt, niet als tags overschrijven.',
        chromeAcceptance: 'Browser-start, HTML/CSS-stappen, previewbewijs en eindstaat blijven zonder clipping op alle vier viewports.',
    },
    enableChat: true,
