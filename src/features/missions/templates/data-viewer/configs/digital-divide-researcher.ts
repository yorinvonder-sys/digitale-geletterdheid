...
export const digitalDivideResearcherConfig: DataViewerConfig = {
    ...
    datasets: [
        ...
        // ── Dataset 2: Staafgrafiek ───────────────────────────────────────────
        {
            ...
            type: 'bar-chart',
            chartData: [
                { label: 'Nederland', value: 98, color: '#e1ff01' },
                { label: 'Zweden', value: 96, color: '#202023' },
                { label: 'Duitsland', value: 91, color: '#202023' },
                { label: 'Spanje', value: 87, color: '#ff3c21' },
                { label: 'Polen', value: 82, color: '#202023' },
                { label: 'Roemenië', value: 68, color: '#202023' },
                { label: 'Bulgarije', value: 62, color: '#ff3c21' },
            ],
            questions: [
                {
