            ...
            questions: [
                {
                    ...
                    correctAnswer: 42,
                    explanation:
                        'Er zijn 5 spam-mails (ID 1, 3, 5, 7 en 10) en 7 geen-spam-mails. 5 ÷ 12 × 100 ≈ 42%. Filter op "Label" = "Spam" om te tellen. Deze dataset is licht ongebalanceerd (5 spam vs 7 geen-spam) — bij scheve datasets kan een model een voorkeur leren voor de meest voorkomende klasse.',
                    points: 15,
                },
                {
                    id: 'q2-beste-feature',
