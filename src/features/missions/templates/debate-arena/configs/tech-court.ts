...
const config: DebateArenaConfig = {
    ...
    takeaways: [
        ...
        'De EU AI Act stelt voor bepaalde hoog-risico AI-systemen extra eisen, zoals risicobeheer, documentatie en menselijk toezicht. Welke eisen gelden, hangt af van de toepassing.',
