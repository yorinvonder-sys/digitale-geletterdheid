...
const FAQ_ITEMS: Array<{ q: string; a: string }> = [
    ...
    },
    {
        ...
        a: 'Alle data wordt opgeslagen binnen de Europese Economische Ruimte (Supabase, AWS Frankfurt). AI-verwerking via Mistral AI en Black Forest Labs server-side via Supabase Edge Functions. Geen data wordt gebruikt voor het trainen van AI-modellen.',
    },
    {
