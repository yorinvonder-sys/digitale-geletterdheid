            ...
            <footer className="relative z-10 mx-auto mt-20 max-w-6xl border-t border-white/10 pt-8 text-sm font-semibold text-white/65">
                <div className="grid gap-8 md:grid-cols-3 md:items-center">
                    ...
                    <div className="flex flex-wrap gap-x-6 gap-y-2 md:justify-end">
                        ...
                        <a href="/leerlijn-digitale-geletterdheid" className="inline-flex min-h-[44px] items-center rounded transition-colors hover:text-duck-acid focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-duck-acid focus-visible:ring-offset-2 focus-visible:ring-offset-duck-ink">Leerlijn &amp; opdrachten</a>
