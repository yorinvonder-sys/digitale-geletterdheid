            ...
            <div className="max-w-5xl mx-auto">
                <div className="text-center mb-12">
                    ...
                    <p className="text-base max-w-2xl mx-auto" style={{ color: '#202023' }}>
                        ...
                        Snel live (binnen 10 werkdagen); privacy by design, data in de EU.
                    </p>
                </div>

                <div className="lg:flex lg:items-stretch lg:gap-6">
                    {/* Pilot card */}
                    <div className="bg-white/5 border border-white/10 rounded-2xl p-6 lg:p-7 flex-1 mb-4 lg:mb-0 ring-2 ring-duck-coral/30 relative overflow-hidden">
                        <div className="text-white text-[10px] font-bold uppercase tracking-wider px-2.5 py-1 rounded-full absolute top-3 right-3" style={{ backgroundColor: '#ff3c21' }}>Aanbevolen</div>
                        <p className="text-xs font-semibold uppercase tracking-wider mb-1" style={{ color: '#ff3c21' }}>Pilot</p>
                        ...
                        <ul className="space-y-2.5 mb-6">
                            {['20+ AI-missies', 'Docenten-dashboard', 'Onboarding 30 min', 'Privacy by design', 'Live binnen 10 werkdagen'].map((item, i) => (
                        ...
                        <div className="flex items-center justify-center gap-1.5 mt-3 text-[11px]" style={{ color: '#202023' }}>
                            <IconShield />
                    ...
                    <div className="bg-white/5 border border-white/10 rounded-2xl p-6 lg:p-7 flex-1 mb-4 lg:mb-0">
                        <p className="text-xs font-semibold uppercase tracking-wider mb-1" style={{ color: '#202023' }}>Na de pilot</p>
                        <p className="text-3xl font-bold text-white mb-1">Vanaf €2.000</p>
                        <p className="text-sm mb-1" style={{ color: '#202023' }}>per schoollocatie / jaar</p>
                    ...
                    <div id="pilot-form" className="flex-[1.3] max-w-lg scroll-mt-24 w-full lg:min-w-[340px]">
                        <p className="text-sm font-medium mb-6" style={{ color: '#ff3c21' }}>Schooljaar 2025-2026 is het laatste volledige pilotjaar vóór de verwachte verplichting in 2027.</p>
                        <div className="bg-white rounded-2xl p-7 shadow-2xl shadow-black/10">
                            {isSubmitted ? (
                                <div className="text-center py-8">
                                    ...
                                    <div className="rounded-xl p-4 text-left" style={{ backgroundColor: '#f2f1ec' }}>
                                        <p className="text-xs font-bold mb-1" style={{ color: '#202023' }}>Wat kun je verwachten?</p>
                                        <ul className="space-y-1 text-xs" style={{ color: '#202023' }}>
                                ...
                                <form onSubmit={handleSubmit} className="space-y-3.5" aria-label="Pilot aanvraagformulier" aria-busy={isSubmitting}>
                                    ...
                                    <div className="text-center mb-2">
                                        <p className="text-sm font-bold" style={{ color: '#202023' }}>Direct aanvragen</p>
                                        <p className="text-xs" style={{ color: '#202023' }}>Reactie binnen 2 werkdagen</p>
                                    </div>

                                    <div>
                                        <label htmlFor="schoolNaam" className="block text-xs font-medium mb-1.5" style={{ color: '#202023' }}>Schoolnaam</label>
                                        <input
                                            id="schoolNaam"
                                            type="text"
                                            required
                                            ...
                                            className="w-full px-3.5 min-h-[44px] bg-duck-bg border border-duck-line rounded-lg outline-none focus:ring-2 focus:ring-duck-coral/20 focus:border-duck-coral transition-all text-sm text-duck-ink placeholder:text-duck-muted"
                                        />
                                    </div>

                                    <div>
                                        <label htmlFor="contactPersoon" className="block text-xs font-medium mb-1.5" style={{ color: '#202023' }}>Naam</label>
                                        <input
                                            id="contactPersoon"
                                            type="text"
                                            required
                                    ...
                                    <div>
                                        <label htmlFor="email" className="block text-xs font-medium mb-1.5" style={{ color: '#202023' }}>E-mail</label>
                                        <input
                                            id="email"
                                            type="email"
                                            required
                                    ...
                                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                                        <div>
                                            <label htmlFor="rol" className="block text-xs font-medium mb-1.5" style={{ color: '#202023' }}>Rol</label>
                                            <select
                                                id="rol"
                                                value={formData.rol}
                                                onChange={(e) => setFormData({ ...formData, rol: e.target.value })}
                                                className="w-full px-3.5 min-h-[44px] bg-duck-bg border border-duck-line rounded-lg outline-none focus:ring-2 focus:ring-duck-coral/20 focus:border-duck-coral transition-all text-sm text-duck-ink appearance-none"
                                            >
                                        ...
                                        <div>
                                            <label htmlFor="aantalLeerlingen" className="block text-xs font-medium mb-1.5" style={{ color: '#202023' }}>Leerlingen</label>
                                            <select
                                                id="aantalLeerlingen"
                                    ...
                                    <div>
                                        <label htmlFor="bericht" className="block text-xs font-medium mb-1.5" style={{ color: '#202023' }}>
                                            Bericht <span style={{ color: '#202023' }}>(optioneel)</span>
                                        </label>
                                        <textarea
                                            id="bericht"
                                            ...
                                            rows={2}
                                            className="w-full px-3.5 py-3 bg-duck-bg border border-duck-line rounded-lg outline-none focus:ring-2 focus:ring-duck-coral/20 focus:border-duck-coral transition-all text-sm text-duck-ink placeholder:text-duck-muted resize-none min-h-[80px]"
                                        />
                                    </div>
                                    ...
                                    <button
                                        ...
                                        className="w-full text-white font-semibold min-h-[48px] rounded-full flex items-center justify-center gap-2 transition-colors text-sm disabled:opacity-60 focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-duck-coral"
                                        style={{ backgroundColor: '#ff3c21' }}
                                    ...
                                    <p className="text-[11px] text-center leading-relaxed" style={{ color: '#202023' }}>
                                        Reactie binnen 2 werkdagen. Livegang binnen 10 werkdagen na akkoord.
                                    </p>
                                    <p className="text-[11px] leading-relaxed" style={{ color: '#202023' }}>
                                        Je gegevens worden verwerkt op grond van precontractueel contact (aanvraag). Verwerking vindt plaats via subverwerkers (o.a. hosting) met passende AVG-overeenkomsten. Zie onze <a href="/ict/privacy/policy" className="underline transition-colors" style={{ color: '#ff3c21' }} onMouseEnter={(e) => (e.currentTarget.style.color = '#D97848')} onMouseLeave={(e) => (e.currentTarget.style.color = '#D97848')}>privacyverklaring</a>.
                                    </p>
                                </form>
                            )}
                        </div>
