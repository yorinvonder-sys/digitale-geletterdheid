...
const STUDENTS: Student[] = [
    {
        id: 1, name: 'Samir K.', initials: 'SK', avatarColor: 'bg-lab-coral',
    ...
    {
        id: 2, name: 'Lisa M.', initials: 'LM', avatarColor: 'bg-lab-coral',
    ...
    {
        id: 3, name: 'Jayden R.', initials: 'JR', avatarColor: 'bg-lab-coral',
    ...
    {
        id: 5, name: 'Noah V.', initials: 'NV', avatarColor: 'bg-lab-coral',
...
const DEMO_STEPS: DemoStep[] = [
    { label: 'Leerling bekijken', accentClass: 'border-lab-teal bg-lab-teal text-white' },
    { label: 'Focus Mode', accentClass: 'border-lab-coral bg-lab-coral text-white' },
    { label: 'Klasoverzicht', accentClass: 'border-lab-sage bg-lab-sage text-white' },
];
...
function AnimatedXpBar({ value, max, animate }: { value: number; max: number; animate: boolean }) {
    ...
    return (
        <div className="w-full h-2 rounded-full bg-lab-cream overflow-hidden">
            <div
...
function StudentCard({
    ...
    return (
        <div
            ...
            } ${isFocusMode ? 'ring-2 ring-lab-coral ring-offset-1' : ''}`}
            style={{
        ...
        >
            <div className="flex items-center gap-2.5 mb-2">
                ...
                <div className="min-w-0 flex-1">
                    <p className="text-sm font-semibold text-lab-ink truncate">{student.name}</p>
            ...
            {isFocusMode && (
                <div className="mt-2 px-2 py-1 rounded-md bg-lab-coral border border-lab-coral text-[10px] text-lab-coral font-medium truncate">
                    {focusMission}
                </div>
            )}
        </div>
    ...
    return (
        <div className={`p-4 space-y-4 transition-all duration-500 ${visible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-2'}`}>
            <div className="flex items-center gap-3">
                ...
                <div>
                    <p className="text-base font-bold text-lab-ink">{student.name}</p>
            ...
            <div>
                ...
                <div className="w-full h-3 rounded-full bg-lab-cream overflow-hidden">
                    <div
            ...
            <div>
                ...
                <div className="flex flex-wrap gap-1.5">
                    {student.sloKerndoelen.map((kd) => (
                        <span key={kd} className="px-2 py-0.5 rounded-full bg-lab-teal border border-lab-teal text-[10px] text-lab-teal font-medium">
                            {kd}
                        </span>
                    ))}
                </div>
            ...
            <div className="grid grid-cols-2 gap-2">
                <div className="p-2 rounded-lg bg-lab-cream border border-lab-line text-center">
                    <p className="text-lg font-bold text-lab-ink">{student.timeSpent}</p>
                    <p className="text-[10px] text-lab-muted">Tijdbesteding</p>
                </div>
                <div className="p-2 rounded-lg bg-lab-cream border border-lab-line text-center">
                    <p className="text-lg font-bold text-lab-ink">{student.streak} dagen</p>
...
export const ScholenLandingDashboardDemo: React.FC = () => {
    ...
    return (
        <div ref={containerRef} className="max-w-6xl mx-auto">
            ...
            >
                {/* Top bar */}
                <div className="flex items-center justify-between px-4 sm:px-6 py-3 border-b border-lab-line bg-lab-cream/50">
                    <div className="flex items-center gap-3">
                        <div className="flex items-center gap-2">
                            <div className="w-3 h-3 rounded-full bg-lab-coral" />
                    ...
                    <div className="flex items-center gap-3">
                        <span className="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-full bg-lab-sage border border-lab-sage text-[11px] font-semibold text-lab-sage">
                            <span className="w-1.5 h-1.5 rounded-full bg-lab-coral animate-pulse" />
                            Live Demo
                        </span>
                        ...
                        <div
                            className={`flex items-center gap-2 px-3 py-1.5 rounded-lg text-xs font-semibold transition-all duration-500 ${
                                focusMode
                                    ? 'bg-lab-coral text-white shadow-md shadow-lab-coral'
                ...
                <div className={`overflow-hidden transition-all duration-500 ${focusMode ? 'max-h-16 opacity-100' : 'max-h-0 opacity-0'}`}>
                    <div className="px-4 sm:px-6 py-2.5 bg-lab-coral border-b border-lab-coral flex items-center gap-2">
                        <span className="w-2 h-2 rounded-full bg-lab-coral animate-pulse" />
                        <p className="text-xs text-lab-coral font-medium">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 min-h-[420px]">
                    ...
                    {/* Detail panel */}
                    <div className="border-t lg:border-t-0 lg:border-l border-lab-line bg-lab-cream/30 min-h-[300px]">
                        <div className="px-4 py-3 border-b border-lab-line">
