...
const FAQ_ITEMS: { category?: string; q: string; a: string }[] = [
    ...
    { category: 'Technisch & privacy', q: 'Hoe regelt DGSkills privacy en veiligheid?', a: 'DPIA en verwerkersovereenkomst beschikbaar; data in een beveiligde EU-database.' },
