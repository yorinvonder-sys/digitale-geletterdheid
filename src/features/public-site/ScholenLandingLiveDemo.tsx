...
export const ScholenLandingLiveDemo: React.FC = () => {
    const [messages, setMessages] = useState<ChatMessage[]>([
        {
            role: 'assistant',
            text: 'Hoi! Ik ben je AI game-mentor. Samen bouwen we een mini-platformer! Welk thema wil je: ruimte, jungle, oceaan, stad, of iets anders?',
        },
    ]);
        ...
        <div className="max-w-6xl mx-auto">
            ...
            <div className="text-center mb-10">
                ...
                <p className="text-base leading-relaxed max-w-xl mx-auto" style={{ color: C.textMuted }}>
                    Chat met de AI en ontwerp je eigen platformer. Kies een thema, karakter en obstakels
                            ...
                            <div key={i} className={`flex ${msg.role === 'user' ? 'justify-end' : 'justify-start'}`}>
                                {msg.role === 'assistant' && (
                                    <div className="w-7 h-7 rounded-full flex items-center justify-center mr-2 mt-1 shrink-0" style={{ backgroundColor: C.accent }}>
                                        <img src="/logo.webp" alt="" className="w-5 h-5 object-contain" width={20} height={20} loading="lazy" decoding="async" />
                                    </div>
                                )}
                                <div
