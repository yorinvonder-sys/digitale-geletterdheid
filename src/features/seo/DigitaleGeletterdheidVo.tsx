...
import { ScholenLandingFeatures } from '../public-site/ScholenLandingFeatures';
    ...
    return (
        <div className="min-h-screen bg-white">
            ...
            <main className="pt-32">
                <section className="px-6 mb-20">
                    <div className="max-w-3xl mx-auto">
                        ...
                        <div className="flex flex-wrap gap-4">
                            <a href="#pilot" className="bg-lab-coral text-white px-8 py-4 rounded-xl font-bold hover:bg-lab-coral hover:text-white transition-all flex items-center gap-2">
                                Start een gratis pilot
                                <IconArrowRight />
                            </a>
                            <a href="/scholen" className="bg-white border border-lab-line text-lab-muted px-8 py-4 rounded-xl font-bold hover:bg-lab-cream transition-all">
                ...
                <section className="py-20 bg-lab-cream border-y border-lab-line px-6">
                    <div className="max-w-5xl mx-auto">
                        <div className="grid md:grid-cols-3 gap-8 mb-16 text-center">
                            <div className="p-6">
                                <div className="text-3xl font-bold text-lab-coral mb-2">SLO 2025</div>
                                <p className="text-lab-muted">Volledig afgestemd op de nieuwste concept-kerndoelen.</p>
                            </div>
                            <div className="p-6">
                                <div className="text-3xl font-bold text-lab-coral mb-2">AI-Missies</div>
                                <p className="text-lab-muted">Leerlingen leren prompten en kritisch denken met AI.</p>
                            </div>
                            <div className="p-6">
                                <div className="text-3xl font-bold text-lab-coral mb-2">AVG-Safe</div>
                                <p className="text-lab-muted">Privacy-proof en data-opslag binnen de EU.</p>
                            </div>
                        </div>
                ...
                <section className="py-20 px-6">
                    <div className="max-w-3xl mx-auto text-center">
                        ...
                        <p className="text-lg text-lab-muted mb-10">
