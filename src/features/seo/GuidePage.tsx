    ...
    if (loading) {
        return (
            <div className="min-h-screen flex items-center justify-center">
                <div className="w-8 h-8 border-2 border-lab-coral border-t-transparent rounded-full animate-spin"></div>
            </div>
        );
    }
        ...
        <div className="min-h-screen bg-white">
            ...
            <main className="pt-32 pb-24 px-6">
                <article className="max-w-3xl mx-auto prose prose-slate prose-indigo">
                    ...
                    <div className="mt-16 pt-8 border-t border-lab-line">
                        <h4 className="font-bold text-lab-ink mb-4">Wil je meer weten over DGSkills?</h4>
                        <div className="flex flex-col sm:flex-row gap-4">
                            <a href="/digitale-geletterdheid-vo" className="inline-flex items-center justify-center px-6 py-3 bg-lab-coral text-white font-bold rounded-xl hover:bg-lab-coral hover:text-white transition-colors">
                                Ontdek de Lesmethode
                            </a>
                            <a href="/scholen" className="inline-flex items-center justify-center px-6 py-3 bg-white border border-lab-line text-lab-muted font-bold rounded-xl hover:bg-lab-cream transition-colors">
                                Bekijk Features
                            </a>
                        </div>
                    </div>
            ...
            <footer className="py-12 bg-lab-cream border-t border-lab-line text-lab-muted text-center text-xs">
