        ...
        <div className="bg-white rounded-2xl border border-lab-line shadow-sm overflow-hidden">
            <div className="p-4 border-b border-lab-line flex items-center justify-between">
                <h3 className="text-sm font-black text-lab-ink uppercase tracking-widest flex items-center gap-2">
                    <ClipboardCheck size={16} className="text-lab-coral" />
            ...
            {recent.length === 0 ? (
                ...
                <div className="overflow-x-auto">
                    <table className="w-full text-sm">
                        <thead className="bg-lab-cream text-lab-muted">
                            <tr>
                        ...
                        <tbody>
                            {recent.map((r) => (
                                <tr key={r.id} className="border-t border-lab-line">
                                    <td className="px-4 py-3">
                                        <div className="font-bold text-lab-ink">{r.studentName}</div>
                                    ...
                                    <td className="px-4 py-3 font-black text-lab-coral">{r.finalScore}%</td>
                                    <td className="px-4 py-3">
                                        {r.passed ? (
                                            ...
                                            <span className="inline-flex items-center gap-1 text-lab-muted font-bold">
