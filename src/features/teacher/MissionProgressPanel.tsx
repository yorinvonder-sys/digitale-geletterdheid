...
export const MissionProgressPanel: React.FC<MissionProgressPanelProps> = ({
    ...
    const getProgressColor = (percentage: number) => {
        if (percentage >= 70) return 'bg-duck-acid';
        if (percentage >= 30) return 'bg-duck-ink/30';
    ...
    return (
        <div className="space-y-6">
            ...
            <div className="overflow-hidden rounded-2xl border border-duck-ink/15 bg-white shadow-sm">
                <div className="flex flex-col gap-5 p-5 md:flex-row md:items-start md:justify-between md:p-6">
                    <div className="flex items-center gap-4">
                        <div className="flex size-14 items-center justify-center rounded-xl border border-duck-ink/15 bg-duck-bgLight text-duck-ink">
                            <BarChart3 size={28} />
                        </div>
                        <div>
                    ...
                    {/* Class Selector */}
                    <div className="flex min-h-[44px] items-center gap-3 rounded-xl border border-duck-ink/15 bg-duck-bgLight px-3 text-duck-ink/60">
                ...
                <div className="grid gap-3 border-t border-duck-ink/15 bg-duck-bgLight px-5 py-4 sm:grid-cols-3 md:px-6">
                    <div className="flex items-center gap-4">
                        <div className="relative size-16">
                            <svg className="h-full w-full -rotate-90">
                                ...
                                <circle
                                    ...
                                    cy="32"
                                    r="25"
                                    className="stroke-duck-acid transition-all duration-200"
                                    strokeWidth="6"
                                    fill="none"
                                    strokeLinecap="round"
                    ...
                    <div className="rounded-xl border border-duck-ink/15 bg-white px-4 py-3">
            ...
            <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3 2xl:grid-cols-4">
                {missionStats.map((mission) => (
                    <motion.div
                        ...
                        layout
                        className="overflow-hidden rounded-2xl border border-duck-ink/15 bg-white shadow-sm transition-shadow hover:shadow-md"
                    >
                        {/* Main Row */}
                        <button
                            type="button"
                        ...
                        >
                            <div className="flex h-full flex-col gap-4">
                                ...
                                <div className="flex items-start justify-between gap-3">
                                    <div className={`flex size-12 items-center justify-center rounded-xl ${getProgressColor(mission.percentage)} text-base font-black text-duck-ink shadow-sm`}>
                                ...
                                <div className="grid grid-cols-3 gap-2 text-xs font-bold">
                                    <span className="flex min-w-0 items-center gap-1 rounded-lg bg-duck-acid px-2 py-2 text-duck-ink">
                                    ...
                                    <span className="flex min-w-0 items-center gap-1 rounded-lg bg-duck-bgLight px-2 py-2 text-duck-ink/60">
                        ...
                        <AnimatePresence>
                            {expandedMission === mission.missionId && (
                                <motion.div
                                    ...
                                    transition={{ duration: 0.2 }}
                                    className="border-t border-duck-ink/15 bg-duck-bgLight"
                                >
                                    <div className="grid grid-cols-3 gap-2 p-3">
                                        <button
                                            onClick={() => setShowStudentList({ mission: mission.missionId, type: 'completed' })}
                                            className="min-h-[44px] rounded-lg border border-duck-acid bg-white p-2 text-center transition-colors hover:bg-duck-acid/20"
                                        >
                                        ...
                                        <button
                                            ...
                                            className="min-h-[44px] rounded-lg border border-duck-ink/15 bg-white p-2 text-center transition-colors hover:bg-duck-ink/10"
                                        >
                                            <div className="text-lg font-black text-duck-ink tabular-nums">{mission.inProgress}</div>
                                        ...
                                        <button
                                            ...
                                            className="min-h-[44px] rounded-lg border border-duck-ink/10 bg-white p-2 text-center transition-colors hover:bg-duck-bgLight"
                                        >
                                            <div className="text-lg font-black text-duck-ink/60 tabular-nums">{mission.notStarted}</div>
            ...
            <AnimatePresence>
                {showStudentList && (
                    <motion.div
                        ...
                        animate={{ opacity: 1 }}
                        exit={{ opacity: 0 }}
                        className="fixed inset-0 z-50 flex items-center justify-center bg-duck-ink/40 p-4"
                    ...
                    >
                        <motion.div
                            ...
                            transition={{ duration: 0.2 }}
                            className="max-h-[70vh] w-full max-w-md overflow-hidden rounded-[1.75rem] border border-duck-ink/15 bg-white shadow-2xl"
                        ...
                        >
                            <div className="flex items-center justify-between border-b border-duck-ink/15 p-4">
                                ...
                                <button
                                    onClick={() => setShowStudentList(null)}
                                    className="min-h-[44px] min-w-[44px] rounded-lg p-2 text-duck-ink/60 hover:bg-duck-bgLight"
                                    ...
                                    <div className="space-y-2">
                                        {currentList.map(student => (
                                            <button
                                                ...
                                                className="flex min-h-[44px] w-full items-center justify-between rounded-xl bg-duck-bgLight p-3 text-left transition-colors hover:bg-duck-bg"
                                            >
                                                ...
                                                <div className="flex items-center gap-2">
                                                    <span className="rounded-lg bg-duck-acid px-2 py-1 text-xs font-bold text-duck-ink tabular-nums">
