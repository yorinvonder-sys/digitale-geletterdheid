        ...
        >
            <div className="bg-white rounded-3xl shadow-2xl w-full max-w-lg my-8 overflow-hidden">
                <div className="px-8 pt-8 pb-4 flex items-center justify-between">
                    <span className="inline-flex items-center gap-2 px-3 py-1 bg-duck-error text-white text-xs font-bold rounded-full uppercase tracking-wide">
                        <Sparkles size={14} />
                        Eerste keer
                    </span>
                    ...
                    <div className="px-8 pb-8">
                        ...
                        <ul className="space-y-3 mb-8">
                            <li className="flex items-start gap-3">
                                <span className="mt-0.5 w-6 h-6 rounded-full bg-duck-error text-white text-xs font-bold flex items-center justify-center shrink-0">
                                    1
                                </span>
                        ...
                        <div className="flex items-center gap-2 text-xs text-duck-ink/60 mb-6">
                            <ShieldCheck size={14} className="text-duck-ink" />
                            <span>
                        ...
                        <button
                            ...
                            className="w-full inline-flex items-center justify-center gap-2 px-6 py-3 bg-duck-error hover:bg-duck-error hover:text-white text-white font-bold rounded-lg text-sm transition-colors focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-duck-error"
                        >
                            Aan de slag
                ...
                {step === 'profile' && (
                    <div className="px-8 pb-8">
                        ...
                        <input
                            ...
                            autoComplete="name"
                            className="w-full px-3.5 min-h-[44px] bg-duck-bg border border-duck-ink/15 rounded-lg outline-none focus:ring-2 focus:ring-duck-error focus:border-duck-error transition-all text-sm text-duck-ink placeholder:text-duck-ink/60"
                        />
                        ...
                        <div className="mt-8 flex flex-col sm:flex-row-reverse gap-3">
                            <button
                                ...
                                className="flex-1 inline-flex items-center justify-center gap-2 px-6 py-3 bg-duck-error hover:bg-duck-error hover:text-white text-white font-bold rounded-lg text-sm transition-colors focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-duck-error"
                            >
                                Volgende
                                <ChevronRight size={16} />
                            </button>
                ...
                {step === 'done' && (
                    <div className="px-8 pb-8">
                        ...
                        <div className="bg-duck-bg rounded-2xl p-5 mb-6">
                        ...
                        <div className="bg-duck-error rounded-2xl p-5 mb-6">
                            <p className="text-[10px] uppercase tracking-wide text-duck-error font-bold mb-2">
                                Wat je hierna kunt
                            </p>
                        ...
                        <div className="flex flex-col sm:flex-row-reverse gap-3">
                            <button
                                ...
                                disabled={isSaving}
                                aria-busy={isSaving}
                                className="flex-1 inline-flex items-center justify-center gap-2 px-6 py-3 bg-duck-error hover:bg-duck-error hover:text-white text-white font-bold rounded-lg text-sm transition-colors disabled:opacity-60 focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-duck-error"
                            >
                                {isSaving ? (
                                    <>
