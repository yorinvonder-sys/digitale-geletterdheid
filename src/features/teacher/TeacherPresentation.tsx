...
const WEEKS_DATA: WeekConfig[] = [
    {
        ...
        slides: [
            ...
            },
            {
                ...
                content: (
                    <div className="space-y-6 text-xl text-duck-ink max-w-4xl mx-auto leading-relaxed">
                        <p>
                ...
                content: (
                    <ul className="space-y-6 text-2xl font-light text-left mx-auto max-w-3xl list-none">
                        {[
                            ...
                            >
                                <Target className="min-w-8 text-duck-ink mt-1" />
                                <span>{goal}</span>
                            </motion.li>
                        ))}
                    </ul>
            ...
            },
            {
                ...
                content: (
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-4 max-w-6xl mx-auto">
                        {[
                            { title: 'Magister Meester', icon: <ShieldAlert />, color: 'bg-duck-error', desc: 'Beheers je cijfers' },
                            { title: 'Cloud Commander', icon: <Database />, color: 'bg-duck-error', desc: 'OneDrive expert' },
                            { title: 'Word Expert', icon: <Pencil />, color: 'bg-duck-error', desc: 'Schrijf als een pro' },
                            { title: 'Presentatie Expert', icon: <Play />, color: 'bg-duck-error', desc: 'Presenteer als een baas' },
                        ].map((m, i) => (
                            <motion.div
                                key={i}
            ...
            },
            {
                ...
                content: (
                    <div className="max-w-4xl mx-auto space-y-8">
                        <div className="bg-duck-error/20 border-2 border-duck-acid/50 rounded-3xl p-8 backdrop-blur-sm">
                            <p className="text-2xl text-duck-ink font-bold leading-relaxed mb-6">
                ...
                bgColor: 'from-duck-acid to-duck-ink',
            },
            {
                type: 'start',
                ...
                content: (
                    <div className="text-center">
                        ...
                        <motion.button
                            ...
                            whileTap={{ scale: 0.95 }}
                            className="bg-white text-duck-ink px-12 py-4 rounded-full font-black text-2xl shadow-glow hover:shadow-xl transition-all"
                        >
                            Start de missies
                        </motion.button>
                    </div>
        ...
        slides: [
            {
                ...
                bgColor: 'from-duck-error to-duck-ink',
            },
            {
                type: 'context',
                ...
                content: (
                    <div className="space-y-8 text-xl text-duck-error max-w-5xl mx-auto leading-relaxed">
                    ...
                    <ul className="space-y-6 text-2xl font-light text-left mx-auto max-w-3xl list-none">
                        {[
                            ...
                            <motion.li
                                ...
                                className="flex items-start gap-4"
                            >
                                <Sparkles className="min-w-8 text-duck-ink mt-1" />
                                <span className="text-white/90">{goal}</span>
                            </motion.li>
                        ))}
                    </ul>
                ),
                bgColor: 'from-fuchsia-900 to-duck-ink',
            },
            {
                type: 'preview',
                title: 'Jouw Missies',
                        ...
                        {[
                            {
                                ...
                                color: 'from-duck-error to-duck-error',
                            ...
                            },
                            {
                                ...
                                color: 'from-duck-error to-duck-ink',
                ...
                bgColor: 'from-duck-ink to-duck-error',
            },
            {
                type: 'disclaimer',
                title: '⚠️ Let Op!',
                ...
                content: (
                    <div className="text-center">
                        <motion.button
                            whileHover={{ scale: 1.1 }}
                            whileTap={{ scale: 0.95 }}
                            className="bg-gradient-to-r from-duck-error to-duck-ink text-white px-12 py-4 rounded-full font-black text-2xl shadow-glow hover:shadow-xl transition-all border-4 border-white/20"
                        >
                            Aan de slag
                        </motion.button>
                    </div>
                    ...
                    <ul className="space-y-6 text-2xl font-light text-left mx-auto max-w-3xl list-none">
                        {[
                            ...
                            <motion.li
                                ...
                                className="flex items-start gap-4"
                            >
                                <ShieldCheck className="min-w-8 text-duck-error mt-1" />
                                <span>{goal}</span>
                            </motion.li>
                        ))}
                    </ul>
            ...
            },
            {
                ...
                content: (
                    <div className="grid grid-cols-2 gap-8 max-w-4xl mx-auto">
                        {[
                            { title: 'AI Spiegel', icon: <UserCheck />, color: 'bg-duck-ink', desc: 'Zie jezelf zoals adverteerders jou zien' },
                            { title: 'Online Beschermer', icon: <AlertCircle />, color: 'bg-duck-error', desc: 'Los conflicten in de groepsapp op' },
                        ].map((m, i) => (
                            <motion.div
                                key={i}
        ...
        slides: [
                    ...
                    <ul className="space-y-6 text-2xl font-light text-left mx-auto max-w-3xl list-none">
                        {[
                            ...
                            <motion.li
                                ...
                                className="flex items-start gap-4"
                            >
                                <Rocket className="min-w-8 text-duck-ink mt-1" />
                                <span>{goal}</span>
                            </motion.li>
                        ))}
                    </ul>
            ...
            },
            {
                ...
                content: (
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-4 max-w-6xl mx-auto">
                        {[
                            { title: 'De Blauwdruk', icon: <Map />, color: 'bg-duck-ink/60', desc: 'Projectplan' },
                            { title: 'De Visie', icon: <Lightbulb />, color: 'bg-duck-error', desc: 'Moodboard & Pitch' },
                            { title: 'De Ethische Raad', icon: <Scale />, color: 'bg-duck-error', desc: 'Slimme Keuzes' },
                            { title: 'De Lancering', icon: <Rocket />, color: 'bg-duck-ink', desc: 'Nu live!' },
                        ].map((m, i) => (
                            <motion.div
                                key={i}
                                initial={{ opacity: 0, y: 30 }}
        ...
        <div className={`fixed inset-0 z-50 bg-black text-white overflow-hidden flex flex-col ${isFullscreen ? 'cursor-none' : ''}`}>
            ...
            <div className={`absolute top-0 left-0 w-full p-4 flex justify-between items-center z-50 transition-opacity duration-300 ${isFullscreen && 'opacity-0 hover:opacity-100'}`}>
                ...
                <div className="flex gap-2">
                    ...
                    <button onClick={onClose} className="p-2 bg-duck-error/80 hover:bg-duck-error hover:text-white rounded-full transition-colors">
                        <X size={24} />
                    </button>
                </div>
            </div>
            ...
            <AnimatePresence mode="wait">
                <motion.div
                    ...
                    className={`flex-1 flex flex-col items-center justify-center relative p-12 bg-gradient-to-br ${currentSlide.bgColor || 'from-duck-ink to-black'}`}
                >
            ...
            <AnimatePresence>
                {showLargeQR && (
                    ...
                    >
                        ...
                        >
                            <div className="text-center">
                                <span className="inline-block px-4 py-1.5 bg-duck-ink text-white rounded-full font-black text-xs uppercase tracking-widest mb-4">
                                    Directe Toegang
                                </span>
                            ...
                            <div className="relative group">
                                <div className="absolute -inset-4 bg-duck-error/10 rounded-[3rem] blur-2xl group-hover:bg-duck-error/20 transition-all duration-500" />
                            ...
                            <div className="flex flex-col items-center gap-4 w-full">
                                ...
                                >
                                    <span>Begrepen</span>
                                    <Sparkles className="text-duck-ink group-hover:rotate-12 transition-transform" />
                                </button>
