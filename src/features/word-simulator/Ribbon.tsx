                                ...
                                <div className="flex items-center gap-0">
                                    ...
                                    <div className="flex items-center">
                                        ...
                                        >
                                            ...
                                            <div className="w-3.5 h-1 bg-lab-coral mt-0.5 -ml-0.5" />
                                        </button>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div className={`flex flex-col items-center px-1 ${!hasSelection ? 'opacity-40' : ''}`}>
                            <div className="flex items-center gap-0.5 flex-1 py-0.5">
                                <button
                                    ...
                                    disabled={!hasSelection}
                                    className="flex flex-col items-center justify-center px-3 py-1 rounded-sm min-w-[52px] hover:bg-lab-coral hover:text-white border border-transparent hover:border-lab-coral cursor-default transition-colors"
