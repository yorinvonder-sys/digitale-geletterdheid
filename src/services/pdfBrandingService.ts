...
export const BRAND = {
    primary:      [217, 120, 72]  as [number, number, number],  // #D97848
    primaryDark:  [217, 120, 72]  as [number, number, number],  // #D97848
    accent:       [95, 148, 125]  as [number, number, number],  // #5F947D
    secondary:    [11, 69, 63]    as [number, number, number],  // #0B453F
    dark:         [8, 40, 59]     as [number, number, number],  // #08283B
    text:         [8, 40, 59]     as [number, number, number],  // #08283B
    textLight:    [68, 88, 101]   as [number, number, number],  // #445865
    muted:        [68, 88, 101]   as [number, number, number],  // #445865
    bg:           [252, 246, 234] as [number, number, number],  // #FCF6EA
    surface:      [255, 253, 247] as [number, number, number],  // #FFFDF7
    border:       [231, 216, 189] as [number, number, number],  // #E7D8BD
    primaryLight: [217, 120, 72, 0.08] as [number, number, number, number], // #D97848 8%
} as const;
