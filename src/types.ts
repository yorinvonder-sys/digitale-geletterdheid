...
export interface ChatMessage {
  ...
  isWelcome?: boolean; // Marks the mission welcome card (renders MissionWelcomeCard instead of ChatBubble)
}
...
export type RoleId =
  ...
  'algorithm-architect' | 'web-developer' | 'network-navigator' | 'app-prototyper' | 'bug-hunter' | 'automation-engineer' | 'code-reviewer' | 'code-review-2' | 'privacy-by-design' | 'wachtwoord-warrior' | 'wachtwoord-fortress' | 'access-control-engineer' |
...
export interface AgentRole {
  ...
  initialCode?: string;
  bonusChallenges?: BonusChallenge[] | null;  // Optional bonus challenges for fast learners
  isReview?: boolean;
