  ...
  public: {
    Tables: {
      ...
      eindmeting_releases: {
        ...
        Relationships: [
          {
            foreignKeyName: "eindmeting_releases_school_id_fkey"
            columns: ["school_id"]
            isOneToOne: false
            referencedRelation: "school_configs"
            referencedColumns: ["school_id"]
      ...
      growth_recommendations: {
        ...
        Relationships: [
          {
            foreignKeyName: "growth_recommendations_school_id_fkey"
            columns: ["school_id"]
            isOneToOne: false
            referencedRelation: "school_configs"
            referencedColumns: ["school_id"]
      ...
      school_branding: {
        Row: {
          ...
          contrast_accent_on_bg: number | null
          contrast_primary_on_bg: number | null
          created_at: string
          created_by: string | null
          custom_mascot_enabled: boolean
    ...
    Functions: {
      ...
      can_access_shared_game: { Args: { p_game_id: string }; Returns: boolean }
      check_xp_rate_limit:
      ...
      is_branding_admin: { Args: never; Returns: boolean }
