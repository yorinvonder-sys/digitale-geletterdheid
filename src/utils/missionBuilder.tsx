...
export const MISSION_OVERRIDES: Record<string, Partial<Mission>> = {
    ...
    'ipad-print-instructies': { isHighlighted: true, classRestriction: 'MH1A', info: 'Ik bekijk vijf printproblemen, zoek uit wat er misgaat en kies steeds de juiste oplossing.' },
...
const DUTCH_MISSION_TITLE_OVERRIDES: Record<string, string> = {
    ...
    'ipad-print-instructies': 'Print Troubleshooter',
