...
export const MISSION_OVERRIDES: Record<string, Partial<Mission>> = {
    ...
    'digital-rights-defender': { info: 'Ik lees perspectieven over schooldata en onderbouw mijn standpunt over digitale rechten met argumenten.' },
    'tech-court': { info: 'Ik beoordeel een AI-rechtszaak vanuit verschillende perspectieven en onderbouw mijn juridische oordeel.' },
    'future-forecaster': { info: 'Ik vergelijk toekomstperspectieven op AI-onderwijs en onderbouw welk model ik voor 2040 kies.' },
    'sustainability-scanner': { info: 'Ik analyseer digitale gebruikstrends, maak berekeningen en onderbouw observaties met concrete cijfers.' },
    'eindproject-j2': { info: 'Ik analyseer resultaten van eerdere eindprojecten en ontdek welke projecttypen en kwaliteiten tot hoge cijfers leiden.' },
...
const DUTCH_MISSION_TITLE_OVERRIDES: Record<string, string> = {
    ...
    'sustainability-scanner': 'Trend Scanner',
