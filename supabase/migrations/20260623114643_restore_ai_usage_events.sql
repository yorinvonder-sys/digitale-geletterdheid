...
-- See migration 20260623100000_restore_ai_usage_events.sql (PR #150).
-- Counters + small operational metadata only. Never store prompts, messages,
-- model outputs, images, or API keys here.
