...
export type RoleId =
  ...
  'algorithm-architect' | 'web-developer' | 'app-prototyper' | 'bug-hunter' | 'automation-engineer' | 'code-reviewer' | 'code-review-2' | 'wachtwoord-warrior' | 'access-control-engineer' |
